...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_rooms_room_boss_01_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_rooms_room_combat_01_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_rooms_room_combat_02_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_rooms_room_neutral_01_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_rooms_room_reward_01_json extends null { }
