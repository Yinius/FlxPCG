...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FlxPCG", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("FlxPCG", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "10";
		app.meta["company"] = "Universidad de Colima";
		app.meta["file"] = "FlxPCG";
		app.meta["name"] = "FlxPCG";
		app.meta["packageName"] = "ucol.flxpcg";
