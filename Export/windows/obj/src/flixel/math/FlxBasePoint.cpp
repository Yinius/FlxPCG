...
HX_DEFINE_STACK_FRAME(_hx_pos_4bc163271948760e_1520_new,"flixel.math.FlxBasePoint","new",0x6212f113,"flixel.math.FlxBasePoint.new","flixel/math/FlxPoint.hx",1520,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1583_set,"flixel.math.FlxBasePoint","set",0x6216bc55,"flixel.math.FlxBasePoint.set","flixel/math/FlxPoint.hx",1583,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1595_put,"flixel.math.FlxBasePoint","put",0x62148382,"flixel.math.FlxBasePoint.put","flixel/math/FlxPoint.hx",1595,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1610_putWeak,"flixel.math.FlxBasePoint","putWeak",0x8df7f51a,"flixel.math.FlxBasePoint.putWeak","flixel/math/FlxPoint.hx",1610,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1624_equals,"flixel.math.FlxBasePoint","equals",0x5cb8ff6c,"flixel.math.FlxBasePoint.equals","flixel/math/FlxPoint.hx",1624,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1633_destroy,"flixel.math.FlxBasePoint","destroy",0xb50f232d,"flixel.math.FlxBasePoint.destroy","flixel/math/FlxPoint.hx",1633,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1640_toString,"flixel.math.FlxBasePoint","toString",0x1fbd4719,"flixel.math.FlxBasePoint.toString","flixel/math/FlxPoint.hx",1640,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1648_set_x,"flixel.math.FlxBasePoint","set_x",0x227e8ece,"flixel.math.FlxBasePoint.set_x","flixel/math/FlxPoint.hx",1648,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1656_set_y,"flixel.math.FlxBasePoint","set_y",0x227e8ecf,"flixel.math.FlxBasePoint.set_y","flixel/math/FlxPoint.hx",1656,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1535_get,"flixel.math.FlxBasePoint","get",0x620da149,"flixel.math.FlxBasePoint.get","flixel/math/FlxPoint.hx",1535,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1554_weak,"flixel.math.FlxBasePoint","weak",0x7472d865,"flixel.math.FlxBasePoint.weak","flixel/math/FlxPoint.hx",1554,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1523_boot,"flixel.math.FlxBasePoint","boot",0x6699001f,"flixel.math.FlxBasePoint.boot","flixel/math/FlxPoint.hx",1523,0xb3e1cd2c)
namespace flixel{
namespace math{
...
void FlxBasePoint_obj::__construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1520_new)
HXLINE(1567)		this->_inPool = false;
HXLINE(1566)		this->_weak = false;
HXLINE(1563)		this->y = ((Float)0);
HXLINE(1562)		this->x = ((Float)0);
HXLINE(1573)		this->set(x,y);
            	}
...
void *FlxBasePoint_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::math::FlxBasePoint FlxBasePoint_obj::set(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            		Float x = __o_x.Default(0);
            		Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1583_set)
HXLINE(1584)		this->set_x(x);
HXLINE(1585)		this->set_y(y);
HXLINE(1586)		return ::hx::ObjectPtr<OBJ_>(this);
            	}
...
void FlxBasePoint_obj::put(){
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1595_put)
HXDLIN(1595)		if (!(this->_inPool)) {
HXLINE(1597)			this->_inPool = true;
HXLINE(1598)			this->_weak = false;
HXLINE(1599)			::flixel::math::FlxBasePoint_obj::pool->putUnsafe(::hx::ObjectPtr<OBJ_>(this));
            		}
            	}
...
void FlxBasePoint_obj::putWeak(){
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1610_putWeak)
HXDLIN(1610)		if (this->_weak) {
HXLINE(1612)			this->put();
            		}
            	}
...
bool FlxBasePoint_obj::equals( ::flixel::math::FlxBasePoint point){
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1624_equals)
HXLINE(1625)		bool result;
HXDLIN(1625)		if ((::Math_obj::abs((this->x - point->x)) <= ((Float)0.0000001))) {
HXLINE(1625)			result = (::Math_obj::abs((this->y - point->y)) <= ((Float)0.0000001));
            		}
            		else {
HXLINE(1625)			result = false;
            		}
HXLINE(1626)		if (point->_weak) {
HXLINE(1626)			point->put();
            		}
HXLINE(1627)		return result;
            	}
...
void FlxBasePoint_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1633_destroy)
            	}
...
::String FlxBasePoint_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1640_toString)
HXDLIN(1640)		 ::Dynamic value = this->x;
HXDLIN(1640)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN(1640)		_this->label = HX_("x",78,00,00,00);
HXDLIN(1640)		_this->value = value;
HXDLIN(1640)		 ::Dynamic value1 = this->y;
HXDLIN(1640)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN(1640)		_this1->label = HX_("y",79,00,00,00);
HXDLIN(1640)		_this1->value = value1;
HXDLIN(1640)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(2)->init(0,_this)->init(1,_this1));
            	}
...
Float FlxBasePoint_obj::set_x(Float Value){
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1648_set_x)
HXDLIN(1648)		return (this->x = Value);
            	}
...
Float FlxBasePoint_obj::set_y(Float Value){
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1656_set_y)
HXDLIN(1656)		return (this->y = Value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxBasePoint_obj,set_y,return )
 ...
 ::flixel::math::FlxBasePoint FlxBasePoint_obj::get(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            		Float x = __o_x.Default(0);
            		Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1535_get)
HXLINE(1537)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
HXLINE(1538)		point->_inPool = false;
HXLINE(1539)		return point;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxBasePoint_obj,get,return )
 ...
 ::flixel::math::FlxBasePoint FlxBasePoint_obj::weak(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            		Float x = __o_x.Default(0);
            		Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1554_weak)
HXLINE(1555)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
HXDLIN(1555)		point->_inPool = false;
HXDLIN(1555)		 ::flixel::math::FlxBasePoint point1 = point;
HXLINE(1557)		point1->_weak = true;
HXLINE(1559)		return point1;
            	}
            		 ...
            		 ::flixel::util::FlxPool _hx_run(){
            			HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0,Float,y,Float,x) HXARGC(0)
            			 ::flixel::math::FlxBasePoint _hx_run(){
            				HX_GC_STACKFRAME(&_hx_pos_4bc163271948760e_1523_boot)
HXDLIN(1523)				return  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,x,y);
            			}
            			HX_END_LOCAL_FUNC0(return)

            			HX_GC_STACKFRAME(&_hx_pos_4bc163271948760e_1523_boot)
HXDLIN(1523)			Float x = ( (Float)(0) );
HXDLIN(1523)			Float y = ( (Float)(0) );
HXDLIN(1523)			return  ::flixel::util::FlxPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0(y,x)));
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1523_boot)
HXDLIN(1523)		pool = ( ( ::flixel::util::FlxPool)( ::Dynamic(new _hx_Closure_1())()) );
            	}
}
