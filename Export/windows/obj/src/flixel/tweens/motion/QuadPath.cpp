...
HXDLIN( 203)		 ::flixel::math::FlxBasePoint safeControl = p1->set(control->x,control->y);
...
HXLINE( 210)			safeControl->set((safeControl->x + ((Float)0.0000001)),(safeControl->y + ((Float)0.0000001)));
            		}
...
HXLINE( 213)			safeControl->set((safeControl->x + ((Float)0.0000001)),(safeControl->y + ((Float)0.0000001)));
            		}
