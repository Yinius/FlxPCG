...
HXLINE( 305)		if (::hx::IsNotNull( this->pendingRemove )) {
HXLINE( 307)			{
HXLINE( 307)				int _g2 = 0;
HXDLIN( 307)				::Array< ::Dynamic> _g3 = this->pendingRemove;
HXDLIN( 307)				while((_g2 < _g3->length)){
HXLINE( 307)					 ::flixel::util::_FlxSignal::FlxSignalHandler handler1 = _g3->__get(_g2).StaticCast<  ::flixel::util::_FlxSignal::FlxSignalHandler >();
HXDLIN( 307)					_g2 = (_g2 + 1);
HXLINE( 309)					if (this->processingListeners) {
HXLINE( 309)						this->pendingRemove->push(handler1);
            					}
            					else {
HXLINE( 309)						this->handlers->remove(handler1);
HXDLIN( 309)						handler1->destroy();
            					}
            				}
            			}
HXLINE( 311)			if ((this->pendingRemove->length > 0)) {
HXLINE( 312)				this->pendingRemove = ::Array_obj< ::Dynamic>::__new(0);
            			}
            		}
            	}
