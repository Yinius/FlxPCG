...
HXLINE( 552)				 ::flixel::math::FlxBasePoint p1 = Vertices->__get(_g).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 552)				_g = (_g + 1);
HXLINE( 554)				::flixel::util::FlxSpriteUtil_obj::flashGfx->lineTo(p1->x,p1->y);
            			}
            		}
HXLINE( 556)		{
