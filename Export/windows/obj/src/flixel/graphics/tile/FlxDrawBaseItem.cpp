...
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_49_reset,"flixel.graphics.tile.FlxDrawBaseItem","reset",0x6670342c,"flixel.graphics.tile.FlxDrawBaseItem.reset","flixel/graphics/tile/FlxDrawBaseItem.hx",49,0xe6349cf4)
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_57_dispose,"flixel.graphics.tile.FlxDrawBaseItem","dispose",0x64897c3c,"flixel.graphics.tile.FlxDrawBaseItem.dispose","flixel/graphics/tile/FlxDrawBaseItem.hx",57,0xe6349cf4)
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_66_render,"flixel.graphics.tile.FlxDrawBaseItem","render",0x386e9259,"flixel.graphics.tile.FlxDrawBaseItem.render","flixel/graphics/tile/FlxDrawBaseItem.hx",66,0xe6349cf4)
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_69_addQuad,"flixel.graphics.tile.FlxDrawBaseItem","addQuad",0x30847725,"flixel.graphics.tile.FlxDrawBaseItem.addQuad","flixel/graphics/tile/FlxDrawBaseItem.hx",69,0xe6349cf4)
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_73_get_numVertices,"flixel.graphics.tile.FlxDrawBaseItem","get_numVertices",0x6c4b2893,"flixel.graphics.tile.FlxDrawBaseItem.get_numVertices","flixel/graphics/tile/FlxDrawBaseItem.hx",73,0xe6349cf4)
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_78_get_numTriangles,"flixel.graphics.tile.FlxDrawBaseItem","get_numTriangles",0x6bc74ed1,"flixel.graphics.tile.FlxDrawBaseItem.get_numTriangles","flixel/graphics/tile/FlxDrawBaseItem.hx",78,0xe6349cf4)
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_23_blendToInt,"flixel.graphics.tile.FlxDrawBaseItem","blendToInt",0xc101e4a6,"flixel.graphics.tile.FlxDrawBaseItem.blendToInt","flixel/graphics/tile/FlxDrawBaseItem.hx",23,0xe6349cf4)
...
HXLINE(  38)		this->blending = 0;
HXLINE(  33)		this->hasColorOffsets = false;
HXLINE(  32)		this->colored = false;
HXLINE(  31)		this->antialiasing = false;
            	}
...
void FlxDrawBaseItem_obj::reset(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_49_reset)
HXLINE(  50)		this->graphics = null();
HXLINE(  51)		this->antialiasing = false;
HXLINE(  52)		this->nextTyped = null();
HXLINE(  53)		this->next = null();
            	}
...
void FlxDrawBaseItem_obj::dispose(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_57_dispose)
HXLINE(  58)		this->graphics = null();
HXLINE(  59)		this->next = null();
HXLINE(  60)		this->type = null();
HXLINE(  61)		this->nextTyped = null();
            	}
...
void FlxDrawBaseItem_obj::render( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_66_render)
HXDLIN(  66)		::flixel::graphics::tile::FlxDrawBaseItem_obj::drawCalls++;
            	}
...
void FlxDrawBaseItem_obj::addQuad( ::flixel::graphics::frames::FlxFrame frame, ::flixel::math::FlxMatrix matrix, ::openfl::geom::ColorTransform transform){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_69_addQuad)
            	}
...
int FlxDrawBaseItem_obj::get_numVertices(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_73_get_numVertices)
HXDLIN(  73)		return 0;
            	}
...
int FlxDrawBaseItem_obj::get_numTriangles(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_78_get_numTriangles)
HXDLIN(  78)		return 0;
            	}
...
int FlxDrawBaseItem_obj::blendToInt( ::Dynamic blend){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_23_blendToInt)
HXDLIN(  23)		return 0;
            	}
