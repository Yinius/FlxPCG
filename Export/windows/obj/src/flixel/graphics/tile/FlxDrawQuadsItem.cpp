...
HX_LOCAL_STACK_FRAME(_hx_pos_6d98322fc3998392_144_setParameterValue,"flixel.graphics.tile.FlxDrawQuadsItem","setParameterValue",0x1b657834,"flixel.graphics.tile.FlxDrawQuadsItem.setParameterValue","flixel/graphics/tile/FlxDrawQuadsItem.hx",144,0x0f089c65)
...
HXLINE( 139)		camera->canvas->get_graphics()->endFill();
HXLINE( 140)		this->super::render(camera);
            	}


void FlxDrawQuadsItem_obj::setParameterValue( ::openfl::display::ShaderParameter_Bool parameter,bool value){
            	HX_STACKFRAME(&_hx_pos_6d98322fc3998392_144_setParameterValue)
HXLINE( 145)		if (::hx::IsNull( parameter->value )) {
HXLINE( 146)			parameter->value = ::Array_obj< bool >::__new(0);
            		}
HXLINE( 147)		parameter->value[0] = value;
            	}
