...
HXLINE( 153)		frame->sourceSize->set(size->width,size->height);
...
HXLINE( 170)		frame->sourceSize->set(region->width,region->height);
HXLINE( 171)		frame->offset->set(0,0);
...
HXLINE( 199)		texFrame->sourceSize->set(sourceSize->x,sourceSize->y);
HXLINE( 200)		texFrame->offset->set(offset->x,offset->y);
...
HXLINE( 262)			( ( ::flixel::graphics::frames::FlxFrame)(this->framesByName->get(name)) )->offset->set(offsetX,offsetY);
            		}
            		else {
...
HXDLIN( 281)			this1->set((this1->x + offsetX),(this1->y + offsetY));
            		}
            		else {
...
HXLINE( 239)					warn = false;
HXLINE( 299)					frame->offset->set(offsetX,offsetY);
            				}
            			}
            		}
HXDLIN( 299)		if (warn) {
...
HXDLIN( 315)						this1->set((this1->x + offsetX),(this1->y + offsetY));
            					}
            				}
            			}
            		}
