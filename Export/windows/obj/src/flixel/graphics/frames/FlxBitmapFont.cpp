...
HXLINE( 467)		charFrame->sourceSize->set(w2,h2);
HXLINE( 468)		if (::hx::IsNotNull( offset )) {
HXLINE( 469)			 ::flixel::math::FlxBasePoint this1 = charFrame->offset;
HXDLIN( 469)			this1->set((this1->x + offset->x),(this1->y + offset->y));
HXDLIN( 469)			{
...
HXDLIN( 539)		this1->set((this1->x + point2->x),(this1->y + point2->y));
HXDLIN( 539)		{
...
HXDLIN( 539)		this2->set((this2->x + border->x),(this2->y + border->y));
HXDLIN( 539)		{
