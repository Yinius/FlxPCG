...
HXDLIN( 517)		this1->set((this1->x + point1->x),(this1->y + point1->y));
HXDLIN( 517)		{
...
HXDLIN( 517)		this2->set((this2->x + border->x),(this2->y + border->y));
HXDLIN( 517)		{
...
HXDLIN( 518)		 ::flixel::math::FlxBasePoint resultSize = this4->set((this4->x - (( (Float)(2) ) * border->x)),(this4->y - (( (Float)(2) ) * border->y)));
...
HXDLIN( 530)		this5->set(p1->x,p1->y);
HXDLIN( 530)		{
...
HXDLIN(  94)		this1->set((this1->x + tileSize->x),(this1->y + tileSize->y));
HXDLIN(  94)		{
...
HXDLIN(  94)		 ::flixel::graphics::frames::FlxTileFrames tileFrames = ::flixel::graphics::frames::FlxTileFrames_obj::fromGraphic(result,this2->set((this2->x + (2 * borderX)),(this2->y + (2 * borderY))),null(),tileSpacing);
...
HXLINE( 147)		tileSpacing->set(( (Float)(::Math_obj::floor(tileSpacing->x)) ),( (Float)(::Math_obj::floor(tileSpacing->y)) ));
HXLINE( 148)		tileSize->set(( (Float)(::Math_obj::floor(tileSize->x)) ),( (Float)(::Math_obj::floor(tileSize->y)) ));
...
HXLINE( 290)		tileSpacing->set(( (Float)(::Math_obj::floor(tileSpacing->x)) ),( (Float)(::Math_obj::floor(tileSpacing->y)) ));
HXLINE( 291)		tileSize->set(( (Float)(::Math_obj::floor(tileSize->x)) ),( (Float)(::Math_obj::floor(tileSize->y)) ));
