...
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1414_fromOpenFL,"flixel.text._FlxText.FlxTextAlign_Impl_","fromOpenFL",0xc584ea03,"flixel.text._FlxText.FlxTextAlign_Impl_.fromOpenFL","flixel/text/FlxText.hx",1414,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1430_toOpenFL,"flixel.text._FlxText.FlxTextAlign_Impl_","toOpenFL",0xa34e3094,"flixel.text._FlxText.FlxTextAlign_Impl_.toOpenFL","flixel/text/FlxText.hx",1430,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1400_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1400,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1407_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1407,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1409_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1409,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1410_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1410,0xdf165a6e)
namespace flixel{
namespace text{
namespace _FlxText{
...
::String FlxTextAlign_Impl__obj::fromOpenFL( ::Dynamic align){
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1414_fromOpenFL)
HXDLIN(1414)		if (::hx::IsNull( align )) {
HXLINE(1419)			return HX_("left",07,08,b0,47);
            		}
            		else {
HXDLIN(1414)			 ::Dynamic _hx_switch_0 = align;
            			if (  (_hx_switch_0==0) ){
HXLINE(1421)				return HX_("center",d5,25,db,05);
HXDLIN(1421)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==2) ){
HXLINE(1423)				return HX_("justify",50,df,b5,83);
HXDLIN(1423)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==3) ){
HXLINE(1420)				return HX_("left",07,08,b0,47);
HXDLIN(1420)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==4) ){
HXLINE(1422)				return HX_("right",dc,0b,64,e9);
HXDLIN(1422)				goto _hx_goto_0;
            			}
            			/* default */{
HXLINE(1424)				return HX_("left",07,08,b0,47);
            			}
            			_hx_goto_0:;
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxTextAlign_Impl__obj,fromOpenFL,return )
 ...
 ::Dynamic FlxTextAlign_Impl__obj::toOpenFL(::String align){
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1430_toOpenFL)
HXDLIN(1430)		::String _hx_switch_0 = align;
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE(1433)			return 0;
HXDLIN(1433)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("justify",50,df,b5,83)) ){
HXLINE(1435)			return 2;
HXDLIN(1435)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("left",07,08,b0,47)) ){
HXLINE(1432)			return 3;
HXDLIN(1432)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE(1434)			return 4;
HXDLIN(1434)			goto _hx_goto_2;
            		}
            		/* default */{
HXLINE(1436)			return 3;
            		}
            		_hx_goto_2:;
HXLINE(1430)		return null();
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1400_boot)
HXDLIN(1400)		LEFT = HX_("left",07,08,b0,47);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1407_boot)
HXDLIN(1407)		CENTER = HX_("center",d5,25,db,05);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1409_boot)
HXDLIN(1409)		RIGHT = HX_("right",dc,0b,64,e9);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1410_boot)
HXDLIN(1410)		JUSTIFY = HX_("justify",50,df,b5,83);
            	}
}
