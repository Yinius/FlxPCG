...
HXLINE(  37)			this->justPressedPosition->set(( (Float)(::flixel::FlxG_obj::mouse->viewX) ),( (Float)(::flixel::FlxG_obj::mouse->viewY) ));
...
HXDLIN(  43)				 ::flixel::math::FlxBasePoint _hx_tmp2 = p->set(this1->x,this1->y);
HXDLIN(  43)				 ::flixel::math::FlxBasePoint _hx_tmp3 = ::flixel::FlxG_obj::mouse->getViewPosition(null(),null());
