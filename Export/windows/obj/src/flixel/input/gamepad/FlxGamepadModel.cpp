...
::flixel::input::gamepad::FlxGamepadModel FlxGamepadModel_obj::PS5;
...
bool FlxGamepadModel_obj::__GetStatic(const ::String &inName, ::Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("PS5",d2,fc,3c,00)) { outValue = FlxGamepadModel_obj::PS5; return true; }
...
int FlxGamepadModel_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("MAYFLASH_WII_REMOTE",22,7b,c7,b9)) return 6;
	if (inName==HX_("MFI",d0,aa,3a,00)) return 8;
	if (inName==HX_("OUYA",6e,a8,78,34)) return 1;
	if (inName==HX_("PS4",d1,fc,3c,00)) return 2;
	if (inName==HX_("PS5",d2,fc,3c,00)) return 3;
	if (inName==HX_("PSVITA",e3,0a,df,ff)) return 4;
	if (inName==HX_("SWITCH_JOYCON_LEFT",6d,d6,f7,ed)) return 10;
	if (inName==HX_("SWITCH_JOYCON_RIGHT",96,d6,f0,c1)) return 11;
	if (inName==HX_("SWITCH_PRO",02,41,68,7a)) return 9;
	if (inName==HX_("UNKNOWN",6a,f7,4e,61)) return 12;
	if (inName==HX_("WII_REMOTE",0e,91,0a,f5)) return 7;
	if (inName==HX_("XINPUT",92,bc,73,6b)) return 5;
...
int FlxGamepadModel_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_("PS5",d2,fc,3c,00)) return 0;
...
::hx::Val FlxGamepadModel_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("PS5",d2,fc,3c,00)) return PS5;
...
MAYFLASH_WII_REMOTE = ::hx::CreateConstEnum< FlxGamepadModel_obj >(HX_("MAYFLASH_WII_REMOTE",22,7b,c7,b9),6);
MFI = ::hx::CreateConstEnum< FlxGamepadModel_obj >(HX_("MFI",d0,aa,3a,00),8);
...
PS5 = ::hx::CreateConstEnum< FlxGamepadModel_obj >(HX_("PS5",d2,fc,3c,00),3);
PSVITA = ::hx::CreateConstEnum< FlxGamepadModel_obj >(HX_("PSVITA",e3,0a,df,ff),4);
SWITCH_JOYCON_LEFT = ::hx::CreateConstEnum< FlxGamepadModel_obj >(HX_("SWITCH_JOYCON_LEFT",6d,d6,f7,ed),10);
SWITCH_JOYCON_RIGHT = ::hx::CreateConstEnum< FlxGamepadModel_obj >(HX_("SWITCH_JOYCON_RIGHT",96,d6,f0,c1),11);
SWITCH_PRO = ::hx::CreateConstEnum< FlxGamepadModel_obj >(HX_("SWITCH_PRO",02,41,68,7a),9);
UNKNOWN = ::hx::CreateConstEnum< FlxGamepadModel_obj >(HX_("UNKNOWN",6a,f7,4e,61),12);
WII_REMOTE = ::hx::CreateConstEnum< FlxGamepadModel_obj >(HX_("WII_REMOTE",0e,91,0a,f5),7);
XINPUT = ::hx::CreateConstEnum< FlxGamepadModel_obj >(HX_("XINPUT",92,bc,73,6b),5);
}
