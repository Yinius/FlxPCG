...
HXLINE( 474)		{
HXLINE( 474)			int _g = 0;
HXDLIN( 474)			::Array< ::Dynamic> _g1 = this->getCameras();
HXDLIN( 474)			while((_g < _g1->length)){
HXLINE( 474)				 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 474)				_g = (_g + 1);
HXLINE( 476)				{
HXLINE( 476)					int _g2 = 0;
HXDLIN( 476)					::Array< ::Dynamic> _g3 = ::flixel::FlxG_obj::touches->list;
HXDLIN( 476)					while((_g2 < _g3->length)){
HXLINE( 476)						 ::flixel::input::touch::FlxTouch touch = _g3->__get(_g2).StaticCast<  ::flixel::input::touch::FlxTouch >();
HXDLIN( 476)						_g2 = (_g2 + 1);
HXLINE( 478)						if (this->checkInput(touch,touch,touch->justPressedPosition,camera)) {
HXLINE( 480)							overlap = true;
            						}
            					}
            				}
            			}
