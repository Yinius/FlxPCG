...
static const ::String _hx_array_data_fdcd68f1_33[] = {
	HX_("screenX",6c,c3,36,2a),HX_("screenY",6d,c3,36,2a),HX_("touchPointID",2c,be,83,7b),HX_("pressed",a2,d2,e6,39),HX_("justPressed",d6,0d,a7,f2),HX_("justReleased",09,1b,5b,66),HX_("isActive",50,dd,af,6e),
};
...
static const ::String _hx_array_data_fdcd68f1_37[] = {
...
HXLINE( 163)			{
HXLINE( 163)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile20 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::flixel::input::touch::FlxTouch >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_33,7),::Array_obj< ::Dynamic>::__new(1)->init(0,::hx::ClassOf< ::flixel::math::FlxBasePoint >()));
HXDLIN( 163)				if (::hx::IsNotNull( Profile20 )) {
HXLINE( 163)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 163)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile20);
            				}
            			}
HXLINE( 174)			{
HXLINE( 174)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile21 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::flixel::input::gamepad::FlxGamepad >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_34,8),null());
HXDLIN( 174)				if (::hx::IsNotNull( Profile21 )) {
HXLINE( 174)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 174)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile21);
            				}
            			}
HXLINE( 178)			{
HXLINE( 178)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile22 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::flixel::input::FlxSwipe >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_35,6),null());
HXDLIN( 178)				if (::hx::IsNotNull( Profile22 )) {
HXLINE( 178)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 178)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile22);
            				}
            			}
HXLINE( 181)			{
HXLINE( 181)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile23 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::openfl::display::DisplayObject >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_36,8),::Array_obj< ::Dynamic>::__new(1)->init(0,::hx::ClassOf< ::flixel::math::FlxRect >()));
HXDLIN( 181)				if (::hx::IsNotNull( Profile23 )) {
HXLINE( 181)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 181)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile23);
            				}
            			}
HXLINE( 182)			{
HXLINE( 182)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile24 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::openfl::geom::Point >(),null(),::Array_obj< ::Dynamic>::__new(1)->init(0,::hx::ClassOf< ::flixel::math::FlxBasePoint >()));
HXDLIN( 182)				if (::hx::IsNotNull( Profile24 )) {
HXLINE( 182)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 182)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile24);
            				}
            			}
HXLINE( 183)			{
HXLINE( 183)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile25 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::openfl::geom::Rectangle >(),null(),::Array_obj< ::Dynamic>::__new(1)->init(0,::hx::ClassOf< ::flixel::math::FlxRect >()));
HXDLIN( 183)				if (::hx::IsNotNull( Profile25 )) {
HXLINE( 183)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 183)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile25);
            				}
            			}
HXLINE( 184)			{
HXLINE( 184)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile26 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::openfl::geom::Matrix >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_37,6),null());
HXDLIN( 184)				if (::hx::IsNotNull( Profile26 )) {
HXLINE( 184)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 184)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile26);
            				}
            			}
            		}
            	}
