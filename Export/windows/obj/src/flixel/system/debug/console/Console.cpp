...
HX_LOCAL_STACK_FRAME(_hx_pos_c69022abc8c5c26b_318_registerObject,"flixel.system.debug.console.Console","registerObject",0x0bbfe598,"flixel.system.debug.console.Console.registerObject","flixel/system/debug/console/Console.hx",318,0x367943c8)
...
HXLINE(  99)		this->input->set_text(HX_("Using the console requires hscript - please run 'haxelib install hscript'.",1a,91,ca,5f));
...
HXLINE( 126)		this->input->addEventListener(HX_("mouseDown",27,b1,c2,ee), ::Dynamic(new _hx_Closure_0(_gthis)),null(),null(),null());
HXLINE( 130)		::openfl::Lib_obj::get_current()->stage->addEventListener(HX_("mouseDown",27,b1,c2,ee), ::Dynamic(new _hx_Closure_1(_gthis)),null(),null(),null());
            	}
...
HXLINE( 168)		if ((this->input->get_text() == HX_("Using the console requires hscript - please run 'haxelib install hscript'.",1a,91,ca,5f))) {
...
HXLINE( 187)			this->input->set_text(HX_("Using the console requires hscript - please run 'haxelib install hscript'.",1a,91,ca,5f));
            		}
...
void Console_obj::registerObject(::String alias, ::Dynamic object){
            	HX_STACKFRAME(&_hx_pos_c69022abc8c5c26b_318_registerObject)
HXDLIN( 318)		this->registeredObjects->set(alias,object);
            	}
...
HXDLIN(  33)		DEFAULT_TEXT = HX_("Using the console requires hscript - please run 'haxelib install hscript'.",1a,91,ca,5f);
            	}
}
