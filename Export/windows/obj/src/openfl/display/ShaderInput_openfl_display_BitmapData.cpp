...
HX_LOCAL_STACK_FRAME(_hx_pos_e18280422777664c_160___updateGL,"openfl.display.ShaderInput_openfl_display_BitmapData","__updateGL",0xe64a7a5b,"openfl.display.ShaderInput_openfl_display_BitmapData.__updateGL","openfl/display/ShaderInput.hx",160,0xcc724ba5)
HX_LOCAL_STACK_FRAME(_hx_pos_e18280422777664c_59_boot,"openfl.display.ShaderInput_openfl_display_BitmapData","boot",0xd2652b3f,"openfl.display.ShaderInput_openfl_display_BitmapData.boot","openfl/display/ShaderInput.hx",59,0xcc724ba5)
namespace openfl{
namespace display{
...
HXLINE( 154)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = context->gl;
HXLINE( 155)		context->setTextureAt(id,null());
            	}
...
void ShaderInput_openfl_display_BitmapData_obj::_hx___updateGL( ::openfl::display3D::Context3D context,int id, ::openfl::display::BitmapData overrideInput, ::Dynamic overrideFilter, ::Dynamic overrideMipFilter, ::Dynamic overrideWrap){
            	HX_STACKFRAME(&_hx_pos_e18280422777664c_160___updateGL)
HXLINE( 161)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = context->gl;
HXLINE( 162)		 ::openfl::display::BitmapData input;
HXDLIN( 162)		if (::hx::IsNotNull( overrideInput )) {
HXLINE( 162)			input = overrideInput;
            		}
            		else {
HXLINE( 162)			input = this->input;
            		}
HXLINE( 163)		 ::Dynamic filter;
HXDLIN( 163)		if (::hx::IsNotNull( overrideFilter )) {
HXLINE( 163)			filter = overrideFilter;
            		}
            		else {
HXLINE( 163)			filter = this->filter;
            		}
HXLINE( 164)		 ::Dynamic mipFilter;
HXDLIN( 164)		if (::hx::IsNotNull( overrideMipFilter )) {
HXLINE( 164)			mipFilter = overrideMipFilter;
            		}
            		else {
HXLINE( 164)			mipFilter = this->mipFilter;
            		}
HXLINE( 165)		 ::Dynamic wrap;
HXDLIN( 165)		if (::hx::IsNotNull( overrideWrap )) {
HXLINE( 165)			wrap = overrideWrap;
            		}
            		else {
HXLINE( 165)			wrap = this->wrap;
            		}
HXLINE( 167)		if (::hx::IsNotNull( input )) {
HXLINE( 171)			 ::openfl::display::BitmapData bitmapData = input;
HXLINE( 172)			context->setTextureAt(id,bitmapData->getTexture(context));
HXLINE( 173)			context->setSamplerStateAt(id,wrap,filter,mipFilter);
            		}
            		else {
HXLINE( 177)			context->setTextureAt(id,null());
            		}
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_e18280422777664c_59_boot)
