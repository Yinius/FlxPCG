...
HX_LOCAL_STACK_FRAME(_hx_pos_0c0edf02bce9ade1_38_fromString,"openfl.display._StageQuality.StageQuality_Impl_","fromString",0xd5e08bb0,"openfl.display._StageQuality.StageQuality_Impl_.fromString","openfl/display/StageQuality.hx",38,0x4c0ba3d1)
HX_LOCAL_STACK_FRAME(_hx_pos_0c0edf02bce9ade1_50_toString,"openfl.display._StageQuality.StageQuality_Impl_","toString",0x0c5a9f41,"openfl.display._StageQuality.StageQuality_Impl_.toString","openfl/display/StageQuality.hx",50,0x4c0ba3d1)
...
bool StageQuality_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic StageQuality_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_0c0edf02bce9ade1_38_fromString)
...
::String StageQuality_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_0c0edf02bce9ade1_50_toString)
HXDLIN(  50)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  52)			return HX_("best",24,f1,13,41);
HXDLIN(  52)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  53)			return HX_("high",62,37,0e,45);
HXDLIN(  53)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  54)			return HX_("low",94,54,52,00);
HXDLIN(  54)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==3) ){
HXLINE(  55)			return HX_("medium",75,54,c8,fe);
