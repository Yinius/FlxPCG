...
HX_LOCAL_STACK_FRAME(_hx_pos_2edbc9abb5fbacde_40_fromString,"openfl.display._StageScaleMode.StageScaleMode_Impl_","fromString",0xa7123530,"openfl.display._StageScaleMode.StageScaleMode_Impl_.fromString","openfl/display/StageScaleMode.hx",40,0x7043b2c3)
HX_LOCAL_STACK_FRAME(_hx_pos_2edbc9abb5fbacde_52_toString,"openfl.display._StageScaleMode.StageScaleMode_Impl_","toString",0x32c6e8c1,"openfl.display._StageScaleMode.StageScaleMode_Impl_.toString","openfl/display/StageScaleMode.hx",52,0x7043b2c3)
HX_LOCAL_STACK_FRAME(_hx_pos_2edbc9abb5fbacde_15_boot,"openfl.display._StageScaleMode.StageScaleMode_Impl_","boot",0x3976adc7,"openfl.display._StageScaleMode.StageScaleMode_Impl_.boot","openfl/display/StageScaleMode.hx",15,0x7043b2c3)
HX_LOCAL_STACK_FRAME(_hx_pos_2edbc9abb5fbacde_22_boot,"openfl.display._StageScaleMode.StageScaleMode_Impl_","boot",0x3976adc7,"openfl.display._StageScaleMode.StageScaleMode_Impl_.boot","openfl/display/StageScaleMode.hx",22,0x7043b2c3)
HX_LOCAL_STACK_FRAME(_hx_pos_2edbc9abb5fbacde_29_boot,"openfl.display._StageScaleMode.StageScaleMode_Impl_","boot",0x3976adc7,"openfl.display._StageScaleMode.StageScaleMode_Impl_.boot","openfl/display/StageScaleMode.hx",29,0x7043b2c3)
HX_LOCAL_STACK_FRAME(_hx_pos_2edbc9abb5fbacde_36_boot,"openfl.display._StageScaleMode.StageScaleMode_Impl_","boot",0x3976adc7,"openfl.display._StageScaleMode.StageScaleMode_Impl_.boot","openfl/display/StageScaleMode.hx",36,0x7043b2c3)
namespace openfl{
namespace display{
...
bool StageScaleMode_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic StageScaleMode_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_2edbc9abb5fbacde_40_fromString)
...
::String StageScaleMode_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_2edbc9abb5fbacde_52_toString)
HXDLIN(  52)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  54)			return HX_("exactFit",52,58,22,25);
HXDLIN(  54)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  55)			return HX_("noBorder",0d,48,2a,34);
HXDLIN(  55)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  56)			return HX_("noScale",89,52,d2,4b);
HXDLIN(  56)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==3) ){
HXLINE(  57)			return HX_("showAll",24,58,96,7b);
...
{
{
            	HX_STACKFRAME(&_hx_pos_2edbc9abb5fbacde_15_boot)
HXDLIN(  15)		EXACT_FIT = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_2edbc9abb5fbacde_22_boot)
HXDLIN(  22)		NO_BORDER = 1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_2edbc9abb5fbacde_29_boot)
HXDLIN(  29)		NO_SCALE = 2;
            	}
{
            	HX_STACKFRAME(&_hx_pos_2edbc9abb5fbacde_36_boot)
HXDLIN(  36)		SHOW_ALL = 3;
            	}
}
