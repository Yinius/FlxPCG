...
HX_LOCAL_STACK_FRAME(_hx_pos_e291141470723f52_44_fromString,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_","fromString",0x5431d0d8,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_.fromString","openfl/display/GraphicsPathWinding.hx",44,0xa8467880)
HX_LOCAL_STACK_FRAME(_hx_pos_e291141470723f52_54_toString,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_","toString",0x816cca69,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_.toString","openfl/display/GraphicsPathWinding.hx",54,0xa8467880)
HX_LOCAL_STACK_FRAME(_hx_pos_e291141470723f52_32_boot,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_","boot",0xb4d09b6f,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_.boot","openfl/display/GraphicsPathWinding.hx",32,0xa8467880)
HX_LOCAL_STACK_FRAME(_hx_pos_e291141470723f52_40_boot,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_","boot",0xb4d09b6f,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_.boot","openfl/display/GraphicsPathWinding.hx",40,0xa8467880)
namespace openfl{
namespace display{
...
bool GraphicsPathWinding_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic GraphicsPathWinding_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_e291141470723f52_44_fromString)
...
::String GraphicsPathWinding_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_e291141470723f52_54_toString)
HXDLIN(  54)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  56)			return HX_("evenOdd",b5,c6,7e,06);
HXDLIN(  56)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  57)			return HX_("nonZero",d5,1e,b4,d1);
...
{
{
            	HX_STACKFRAME(&_hx_pos_e291141470723f52_32_boot)
HXDLIN(  32)		EVEN_ODD = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_e291141470723f52_40_boot)
HXDLIN(  40)		NON_ZERO = 1;
            	}
}
