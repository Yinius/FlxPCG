...
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_864___renderDrawable,"openfl.display.OpenGLRenderer","__renderDrawable",0x47336226,"openfl.display.OpenGLRenderer.__renderDrawable","openfl/display/OpenGLRenderer.hx",864,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_890___renderDrawableMask,"openfl.display.OpenGLRenderer","__renderDrawableMask",0xb5f5da32,"openfl.display.OpenGLRenderer.__renderDrawableMask","openfl/display/OpenGLRenderer.hx",890,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_916___renderFilterPass,"openfl.display.OpenGLRenderer","__renderFilterPass",0xd0419531,"openfl.display.OpenGLRenderer.__renderFilterPass","openfl/display/OpenGLRenderer.hx",916,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_959___resize,"openfl.display.OpenGLRenderer","__resize",0x27660106,"openfl.display.OpenGLRenderer.__resize","openfl/display/OpenGLRenderer.hx",959,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_976___resumeClipAndMask,"openfl.display.OpenGLRenderer","__resumeClipAndMask",0x7bcaa3f4,"openfl.display.OpenGLRenderer.__resumeClipAndMask","openfl/display/OpenGLRenderer.hx",976,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1000___scissorRect,"openfl.display.OpenGLRenderer","__scissorRect",0xbdd8570e,"openfl.display.OpenGLRenderer.__scissorRect","openfl/display/OpenGLRenderer.hx",1000,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1031___setBlendMode,"openfl.display.OpenGLRenderer","__setBlendMode",0xc7ebe4e4,"openfl.display.OpenGLRenderer.__setBlendMode","openfl/display/OpenGLRenderer.hx",1031,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1068___setRenderTarget,"openfl.display.OpenGLRenderer","__setRenderTarget",0xe23db0b7,"openfl.display.OpenGLRenderer.__setRenderTarget","openfl/display/OpenGLRenderer.hx",1068,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1079___setShaderBuffer,"openfl.display.OpenGLRenderer","__setShaderBuffer",0x2c781375,"openfl.display.OpenGLRenderer.__setShaderBuffer","openfl/display/OpenGLRenderer.hx",1079,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1085___suspendClipAndMask,"openfl.display.OpenGLRenderer","__suspendClipAndMask",0x40692e69,"openfl.display.OpenGLRenderer.__suspendClipAndMask","openfl/display/OpenGLRenderer.hx",1085,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1100___updateShaderBuffer,"openfl.display.OpenGLRenderer","__updateShaderBuffer",0x07dc8fc0,"openfl.display.OpenGLRenderer.__updateShaderBuffer","openfl/display/OpenGLRenderer.hx",1100,0x89bd8a40)
...
HXLINE( 762)			if (this->_hx___context3D->_hx___backBufferWantsBestResolution) {
HXLINE( 764)				::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo((( (Float)(this->_hx___offsetX) ) / this->_hx___pixelRatio),(( (Float)(this->_hx___offsetY) ) / this->_hx___pixelRatio),(( (Float)(this->_hx___displayWidth) ) / this->_hx___pixelRatio),(( (Float)(this->_hx___displayHeight) ) / this->_hx___pixelRatio));
            			}
            			else {
HXLINE( 768)				::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(( (Float)(this->_hx___offsetX) ),( (Float)(this->_hx___offsetY) ),( (Float)(this->_hx___displayWidth) ),( (Float)(this->_hx___displayHeight) ));
            			}
HXLINE( 771)			this->_hx___context3D->setScissorRectangle(::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle);
HXLINE( 773)			bool _hx_tmp;
HXDLIN( 773)			if ((this->_hx___worldTransform->a == 1)) {
HXLINE( 773)				_hx_tmp = (this->_hx___worldTransform->d != 1);
            			}
            			else {
HXLINE( 773)				_hx_tmp = true;
            			}
HXDLIN( 773)			this->_hx___upscaled = _hx_tmp;
HXLINE( 775)			this->_hx___renderDrawable(object);
HXLINE( 779)			bool _hx_tmp1;
HXDLIN( 779)			if ((this->_hx___offsetX <= 0)) {
HXLINE( 779)				_hx_tmp1 = (this->_hx___offsetY > 0);
            			}
            			else {
HXLINE( 779)				_hx_tmp1 = true;
            			}
HXDLIN( 779)			if (_hx_tmp1) {
HXLINE( 783)				if ((this->_hx___offsetX > 0)) {
HXLINE( 786)					::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(( (Float)(0) ),( (Float)(0) ),( (Float)(this->_hx___offsetX) ),( (Float)(this->_hx___height) ));
HXLINE( 787)					this->_hx___context3D->setScissorRectangle(::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle);
HXLINE( 789)					this->_hx___context3D->_hx___flushGL();
HXLINE( 790)					this->_hx___gl->clearColor(( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ));
HXLINE( 791)					this->_hx___gl->clear(this->_hx___gl->COLOR_BUFFER_BIT);
HXLINE( 795)					::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(( (Float)((this->_hx___offsetX + this->_hx___displayWidth)) ),( (Float)(0) ),( (Float)(this->_hx___width) ),( (Float)(this->_hx___height) ));
HXLINE( 796)					this->_hx___context3D->setScissorRectangle(::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle);
HXLINE( 798)					this->_hx___context3D->_hx___flushGL();
HXLINE( 799)					this->_hx___gl->clearColor(( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ));
HXLINE( 800)					this->_hx___gl->clear(this->_hx___gl->COLOR_BUFFER_BIT);
            				}
HXLINE( 804)				if ((this->_hx___offsetY > 0)) {
HXLINE( 807)					::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(( (Float)(0) ),( (Float)(0) ),( (Float)(this->_hx___width) ),( (Float)(this->_hx___offsetY) ));
HXLINE( 808)					this->_hx___context3D->setScissorRectangle(::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle);
HXLINE( 810)					this->_hx___context3D->_hx___flushGL();
HXLINE( 811)					this->_hx___gl->clearColor(( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ));
HXLINE( 812)					this->_hx___gl->clear(this->_hx___gl->COLOR_BUFFER_BIT);
HXLINE( 816)					::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(( (Float)(0) ),( (Float)((this->_hx___offsetY + this->_hx___displayHeight)) ),( (Float)(this->_hx___width) ),( (Float)(this->_hx___height) ));
HXLINE( 817)					this->_hx___context3D->setScissorRectangle(::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle);
HXLINE( 819)					this->_hx___context3D->_hx___flushGL();
HXLINE( 820)					this->_hx___gl->clearColor(( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ));
HXLINE( 821)					this->_hx___gl->clear(this->_hx___gl->COLOR_BUFFER_BIT);
            				}
HXLINE( 825)				this->_hx___context3D->setScissorRectangle(null());
            			}
            		}
            		else {
HXLINE( 833)			if (this->_hx___context3D->_hx___backBufferWantsBestResolution) {
HXLINE( 835)				::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo((( (Float)(this->_hx___offsetX) ) / this->_hx___pixelRatio),(( (Float)(this->_hx___offsetY) ) / this->_hx___pixelRatio),(( (Float)(this->_hx___displayWidth) ) / this->_hx___pixelRatio),(( (Float)(this->_hx___displayHeight) ) / this->_hx___pixelRatio));
            			}
            			else {
HXLINE( 839)				::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(( (Float)(this->_hx___offsetX) ),( (Float)(this->_hx___offsetY) ),( (Float)(this->_hx___displayWidth) ),( (Float)(this->_hx___displayHeight) ));
            			}
HXLINE( 842)			this->_hx___context3D->setScissorRectangle(::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle);
HXLINE( 849)			 ::openfl::display::DisplayObject cacheMask = ( ( ::openfl::display::DisplayObject)(object->__Field(HX_("__mask",0c,a4,4e,f7),::hx::paccDynamic)) );
HXLINE( 850)			 ::openfl::geom::Rectangle cacheScrollRect = ( ( ::openfl::geom::Rectangle)(object->__Field(HX_("__scrollRect",f1,56,fa,41),::hx::paccDynamic)) );
HXLINE( 851)			object->__SetField(HX_("__mask",0c,a4,4e,f7),null(),::hx::paccDynamic);
HXLINE( 852)			object->__SetField(HX_("__scrollRect",f1,56,fa,41),null(),::hx::paccDynamic);
HXLINE( 854)			this->_hx___renderDrawable(object);
HXLINE( 856)			object->__SetField(HX_("__mask",0c,a4,4e,f7),cacheMask,::hx::paccDynamic);
HXLINE( 857)			object->__SetField(HX_("__scrollRect",f1,56,fa,41),cacheScrollRect,::hx::paccDynamic);
            		}
HXLINE( 860)		this->_hx___context3D->present();
            	}


void OpenGLRenderer_obj::_hx___renderDrawable(::Dynamic object){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_864___renderDrawable)
HXLINE( 865)		if (::hx::IsNull( object )) {
HXLINE( 865)			return;
            		}
HXLINE( 867)		switch((int)(( (int)(object->__Field(HX_("__drawableType",98,b4,3c,42),::hx::paccDynamic)) ))){
            			case (int)0: {
HXLINE( 870)				::openfl::display::_internal::Context3DBitmapData_obj::renderDrawable(( ( ::openfl::display::BitmapData)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)2: {
HXLINE( 874)				::openfl::display::_internal::Context3DBitmap_obj::renderDrawable(( ( ::openfl::display::Bitmap)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)3: {
HXLINE( 876)				::openfl::display::_internal::Context3DDisplayObject_obj::renderDrawable(( ( ::openfl::display::DisplayObject)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)4: case (int)5: {
HXLINE( 872)				::openfl::display::_internal::Context3DDisplayObjectContainer_obj::renderDrawable(( ( ::openfl::display::DisplayObjectContainer)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)6: {
HXLINE( 878)				::openfl::display::_internal::Context3DSimpleButton_obj::renderDrawable(( ( ::openfl::display::SimpleButton)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)7: {
HXLINE( 880)				::openfl::display::_internal::Context3DTextField_obj::renderDrawable(( ( ::openfl::text::TextField)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)8: {
HXLINE( 882)				::openfl::display::_internal::Context3DVideo_obj::renderDrawable(( ( ::openfl::media::Video)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)9: {
HXLINE( 884)				::openfl::display::_internal::Context3DTilemap_obj::renderDrawable(( ( ::openfl::display::Tilemap)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			default:{
            			}
...
void OpenGLRenderer_obj::_hx___renderDrawableMask(::Dynamic object){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_890___renderDrawableMask)
HXLINE( 891)		if (::hx::IsNull( object )) {
HXLINE( 891)			return;
            		}
HXLINE( 893)		switch((int)(( (int)(object->__Field(HX_("__drawableType",98,b4,3c,42),::hx::paccDynamic)) ))){
            			case (int)0: {
HXLINE( 896)				::openfl::display::_internal::Context3DBitmapData_obj::renderDrawableMask(( ( ::openfl::display::BitmapData)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)2: {
HXLINE( 900)				::openfl::display::_internal::Context3DBitmap_obj::renderDrawableMask(( ( ::openfl::display::Bitmap)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)3: {
HXLINE( 902)				::openfl::display::_internal::Context3DDisplayObject_obj::renderDrawableMask(( ( ::openfl::display::DisplayObject)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)4: case (int)5: {
HXLINE( 898)				::openfl::display::_internal::Context3DDisplayObjectContainer_obj::renderDrawableMask(( ( ::openfl::display::DisplayObjectContainer)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)6: {
HXLINE( 904)				::openfl::display::_internal::Context3DSimpleButton_obj::renderDrawableMask(( ( ::openfl::display::SimpleButton)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)7: {
HXLINE( 906)				::openfl::display::_internal::Context3DTextField_obj::renderDrawableMask(( ( ::openfl::text::TextField)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)8: {
HXLINE( 908)				::openfl::display::_internal::Context3DVideo_obj::renderDrawableMask(( ( ::openfl::media::Video)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			case (int)9: {
HXLINE( 910)				::openfl::display::_internal::Context3DTilemap_obj::renderDrawableMask(( ( ::openfl::display::Tilemap)(object) ),::hx::ObjectPtr<OBJ_>(this));
            			}
            			break;
            			default:{
            			}
...
void OpenGLRenderer_obj::_hx___renderFilterPass( ::openfl::display::BitmapData source, ::openfl::display::Shader shader,bool smooth,::hx::Null< bool >  __o_clear){
            	...
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_916___renderFilterPass)
HXLINE( 917)		bool _hx_tmp;
HXDLIN( 917)		if (::hx::IsNotNull( source )) {
HXLINE( 917)			_hx_tmp = ::hx::IsNull( shader );
            		}
            		else {
...
HXLINE( 918)		if (::hx::IsNull( this->_hx___defaultRenderTarget )) {
HXLINE( 918)			return;
            		}
HXLINE( 920)		 ::openfl::display3D::textures::TextureBase cacheRTT = this->_hx___context3D->_hx___state->renderToTexture;
HXLINE( 921)		bool cacheRTTDepthStencil = this->_hx___context3D->_hx___state->renderToTextureDepthStencil;
HXLINE( 922)		int cacheRTTAntiAlias = this->_hx___context3D->_hx___state->renderToTextureAntiAlias;
HXLINE( 923)		int cacheRTTSurfaceSelector = this->_hx___context3D->_hx___state->renderToTextureSurfaceSelector;
HXLINE( 925)		 ::openfl::display3D::Context3D _hx_tmp1 = this->_hx___context3D;
HXDLIN( 925)		_hx_tmp1->setRenderToTexture(this->_hx___defaultRenderTarget->getTexture(this->_hx___context3D),false,null(),null());
HXLINE( 927)		if (clear) {
HXLINE( 929)			this->_hx___context3D->clear(0,0,0,0,0,0,1);
            		}
HXLINE( 932)		 ::openfl::display::Shader shader1 = this->_hx___initShader(shader);
HXLINE( 933)		this->setShader(shader1);
HXLINE( 934)		this->applyAlpha(( (Float)(1) ));
HXLINE( 935)		this->applyBitmapData(source,smooth,null());
HXLINE( 936)		this->applyColorTransform(null());
HXLINE( 937)		this->applyMatrix(this->_hx___getMatrix(source->_hx___renderTransform,1));
HXLINE( 938)		this->updateShader();
HXLINE( 940)		 ::openfl::display3D::VertexBuffer3D vertexBuffer = source->getVertexBuffer(this->_hx___context3D,null(),null());
HXLINE( 941)		if (::hx::IsNotNull( shader1->_hx___position )) {
HXLINE( 941)			this->_hx___context3D->setVertexBufferAt(( (int)(shader1->_hx___position->index) ),vertexBuffer,0,3);
            		}
HXLINE( 942)		if (::hx::IsNotNull( shader1->_hx___textureCoord )) {
HXLINE( 942)			this->_hx___context3D->setVertexBufferAt(( (int)(shader1->_hx___textureCoord->index) ),vertexBuffer,3,2);
            		}
HXLINE( 943)		 ::openfl::display3D::IndexBuffer3D indexBuffer = source->getIndexBuffer(this->_hx___context3D,null());
HXLINE( 944)		this->_hx___context3D->drawTriangles(indexBuffer,null(),null());
HXLINE( 946)		if (::hx::IsNotNull( cacheRTT )) {
HXLINE( 948)			this->_hx___context3D->setRenderToTexture(cacheRTT,cacheRTTDepthStencil,cacheRTTAntiAlias,cacheRTTSurfaceSelector);
            		}
            		else {
HXLINE( 952)			this->_hx___context3D->setRenderToBackBuffer();
            		}
HXLINE( 955)		this->_hx___clearShader();
            	}
...
void OpenGLRenderer_obj::_hx___resize(int width,int height){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_959___resize)
HXLINE( 960)		this->_hx___width = width;
HXLINE( 961)		this->_hx___height = height;
HXLINE( 963)		int w;
HXDLIN( 963)		if (::hx::IsNull( this->_hx___defaultRenderTarget )) {
HXLINE( 963)			w = this->_hx___stage->stageWidth;
            		}
            		else {
HXLINE( 963)			w = this->_hx___defaultRenderTarget->width;
            		}
HXLINE( 964)		int h;
HXDLIN( 964)		if (::hx::IsNull( this->_hx___defaultRenderTarget )) {
HXLINE( 964)			h = this->_hx___stage->stageHeight;
            		}
            		else {
HXLINE( 964)			h = this->_hx___defaultRenderTarget->height;
            		}
HXLINE( 966)		int _hx_tmp;
HXDLIN( 966)		if (::hx::IsNull( this->_hx___defaultRenderTarget )) {
HXLINE( 966)			 ::openfl::geom::Matrix _this = this->_hx___worldTransform;
HXDLIN( 966)			_hx_tmp = ::Math_obj::round((((( (Float)(0) ) * _this->a) + (( (Float)(0) ) * _this->c)) + _this->tx));
            		}
            		else {
HXLINE( 966)			_hx_tmp = 0;
            		}
HXDLIN( 966)		this->_hx___offsetX = _hx_tmp;
HXLINE( 967)		int _hx_tmp1;
HXDLIN( 967)		if (::hx::IsNull( this->_hx___defaultRenderTarget )) {
HXLINE( 967)			 ::openfl::geom::Matrix _this1 = this->_hx___worldTransform;
HXDLIN( 967)			_hx_tmp1 = ::Math_obj::round((((( (Float)(0) ) * _this1->b) + (( (Float)(0) ) * _this1->d)) + _this1->ty));
            		}
            		else {
HXLINE( 967)			_hx_tmp1 = 0;
            		}
HXDLIN( 967)		this->_hx___offsetY = _hx_tmp1;
HXLINE( 968)		int _hx_tmp2;
HXDLIN( 968)		if (::hx::IsNull( this->_hx___defaultRenderTarget )) {
HXLINE( 968)			 ::openfl::geom::Matrix _this2 = this->_hx___worldTransform;
HXDLIN( 968)			_hx_tmp2 = ::Math_obj::round(((((( (Float)(w) ) * _this2->a) + (( (Float)(0) ) * _this2->c)) + _this2->tx) - ( (Float)(this->_hx___offsetX) )));
            		}
            		else {
HXLINE( 968)			_hx_tmp2 = w;
            		}
HXDLIN( 968)		this->_hx___displayWidth = _hx_tmp2;
HXLINE( 969)		int _hx_tmp3;
HXDLIN( 969)		if (::hx::IsNull( this->_hx___defaultRenderTarget )) {
HXLINE( 969)			 ::openfl::geom::Matrix _this3 = this->_hx___worldTransform;
HXDLIN( 969)			_hx_tmp3 = ::Math_obj::round(((((( (Float)(0) ) * _this3->b) + (( (Float)(h) ) * _this3->d)) + _this3->ty) - ( (Float)(this->_hx___offsetY) )));
            		}
            		else {
HXLINE( 969)			_hx_tmp3 = h;
            		}
HXDLIN( 969)		this->_hx___displayHeight = _hx_tmp3;
HXLINE( 971)		::lime::math::_Matrix4::Matrix4_Impl__obj::createOrtho(this->_hx___projection,( (Float)(0) ),( (Float)((this->_hx___displayWidth + (this->_hx___offsetX * 2))) ),( (Float)(0) ),( (Float)((this->_hx___displayHeight + (this->_hx___offsetY * 2))) ),( (Float)(-1000) ),( (Float)(1000) ));
HXLINE( 972)		::lime::math::_Matrix4::Matrix4_Impl__obj::createOrtho(this->_hx___projectionFlipped,( (Float)(0) ),( (Float)((this->_hx___displayWidth + (this->_hx___offsetX * 2))) ),( (Float)((this->_hx___displayHeight + (this->_hx___offsetY * 2))) ),( (Float)(0) ),( (Float)(-1000) ),( (Float)(1000) ));
            	}


void OpenGLRenderer_obj::_hx___resumeClipAndMask( ::openfl::display::OpenGLRenderer childRenderer){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_976___resumeClipAndMask)
HXLINE( 977)		if ((this->_hx___stencilReference > 0)) {
HXLINE( 979)			this->_hx___context3D->setStencilActions(2,1,5,5,5);
HXLINE( 980)			this->_hx___context3D->setStencilReferenceValue(this->_hx___stencilReference,255,0);
            		}
            		else {
HXLINE( 984)			this->_hx___context3D->setStencilActions(null(),null(),null(),null(),null());
HXLINE( 985)			this->_hx___context3D->setStencilReferenceValue(0,0,0);
            		}
HXLINE( 988)		if ((this->_hx___numClipRects > 0)) {
HXLINE( 990)			this->_hx___scissorRect(this->_hx___clipRects->__get((this->_hx___numClipRects - 1)).StaticCast<  ::openfl::geom::Rectangle >());
            		}
            		else {
HXLINE( 994)			this->_hx___scissorRect(null());
            		}
            	}
...
void OpenGLRenderer_obj::_hx___scissorRect( ::openfl::geom::Rectangle clipRect){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1000___scissorRect)
HXDLIN(1000)		if (::hx::IsNotNull( clipRect )) {
HXLINE(1002)			Float x = ::Math_obj::ffloor(clipRect->x);
HXLINE(1003)			Float y = ::Math_obj::ffloor(clipRect->y);
HXLINE(1004)			Float width;
HXDLIN(1004)			if ((clipRect->width > 0)) {
HXLINE(1004)				width = (::Math_obj::fceil(clipRect->get_right()) - x);
            			}
            			else {
HXLINE(1004)				width = ( (Float)(0) );
            			}
HXLINE(1005)			Float height;
HXDLIN(1005)			if ((clipRect->height > 0)) {
HXLINE(1005)				height = (::Math_obj::fceil(clipRect->get_bottom()) - y);
            			}
            			else {
HXLINE(1005)				height = ( (Float)(0) );
            			}
HXLINE(1007)			if (this->_hx___context3D->_hx___backBufferWantsBestResolution) {
HXLINE(1009)				Float uv = (((Float)1.5) / this->_hx___pixelRatio);
HXLINE(1010)				x = (clipRect->x / this->_hx___pixelRatio);
HXLINE(1011)				y = (clipRect->y / this->_hx___pixelRatio);
HXLINE(1012)				if ((clipRect->width > 0)) {
HXLINE(1012)					Float width1 = clipRect->get_right();
HXDLIN(1012)					width = (((width1 / this->_hx___pixelRatio) - x) + uv);
            				}
            				else {
HXLINE(1012)					width = ( (Float)(0) );
            				}
HXLINE(1013)				if ((clipRect->height > 0)) {
HXLINE(1013)					Float height1 = clipRect->get_bottom();
HXDLIN(1013)					height = (((height1 / this->_hx___pixelRatio) - y) + uv);
            				}
            				else {
HXLINE(1013)					height = ( (Float)(0) );
            				}
            			}
HXLINE(1017)			if ((width < 0)) {
HXLINE(1017)				width = ( (Float)(0) );
            			}
HXLINE(1018)			if ((height < 0)) {
HXLINE(1018)				height = ( (Float)(0) );
            			}
HXLINE(1021)			::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(x,y,width,height);
HXLINE(1022)			this->_hx___context3D->setScissorRectangle(::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle);
            		}
            		else {
HXLINE(1026)			this->_hx___context3D->setScissorRectangle(null());
            		}
            	}
...
void OpenGLRenderer_obj::_hx___setBlendMode( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1031___setBlendMode)
HXLINE(1032)		if (::hx::IsNotNull( this->_hx___overrideBlendMode )) {
HXLINE(1032)			value = this->_hx___overrideBlendMode;
            		}
HXLINE(1033)		if (::hx::IsEq( this->_hx___blendMode,value )) {
HXLINE(1033)			return;
            		}
HXLINE(1035)		this->_hx___blendMode = value;
HXLINE(1037)		 ::Dynamic _hx_switch_0 = value;
            		if (  (_hx_switch_0==0) ){
HXLINE(1040)			this->_hx___context3D->setBlendFactors(2,2);
HXDLIN(1040)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(1054)			this->_hx___context3D->setBlendFactors(2,2);
HXLINE(1055)			this->_hx___context3D->_hx___setGLBlendEquation(32775);
HXLINE(1053)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==8) ){
HXLINE(1058)			this->_hx___context3D->setBlendFactors(2,2);
HXLINE(1059)			this->_hx___context3D->_hx___setGLBlendEquation(32776);
HXLINE(1057)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==9) ){
HXLINE(1043)			this->_hx___context3D->setBlendFactors(1,5);
HXDLIN(1043)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==12) ){
HXLINE(1046)			this->_hx___context3D->setBlendFactors(2,6);
HXDLIN(1046)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==14) ){
HXLINE(1049)			this->_hx___context3D->setBlendFactors(2,2);
HXLINE(1050)			this->_hx___context3D->_hx___setGLBlendEquation(this->_hx___gl->FUNC_REVERSE_SUBTRACT);
HXLINE(1048)			goto _hx_goto_35;
            		}
            		/* default */{
HXLINE(1063)			this->_hx___context3D->setBlendFactors(2,5);
            		}
            		_hx_goto_35:;
            	}
...
void OpenGLRenderer_obj::_hx___setRenderTarget( ::openfl::display::BitmapData renderTarget){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1068___setRenderTarget)
HXLINE(1069)		this->_hx___defaultRenderTarget = renderTarget;
HXLINE(1070)		this->_hx___flipped = ::hx::IsNull( renderTarget );
HXLINE(1072)		if (::hx::IsNotNull( renderTarget )) {
HXLINE(1074)			this->_hx___resize(renderTarget->width,renderTarget->height);
            		}
            	}
...
void OpenGLRenderer_obj::_hx___setShaderBuffer( ::openfl::display::_internal::ShaderBuffer shaderBuffer){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1079___setShaderBuffer)
...
void OpenGLRenderer_obj::_hx___suspendClipAndMask(){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1085___suspendClipAndMask)
HXLINE(1086)		if ((this->_hx___stencilReference > 0)) {
HXLINE(1088)			this->_hx___context3D->setStencilActions(null(),null(),null(),null(),null());
HXLINE(1089)			this->_hx___context3D->setStencilReferenceValue(0,0,0);
            		}
HXLINE(1092)		if ((this->_hx___numClipRects > 0)) {
HXLINE(1094)			this->_hx___scissorRect(null());
            		}
            	}
...
void OpenGLRenderer_obj::_hx___updateShaderBuffer(int bufferOffset){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1100___updateShaderBuffer)
HXDLIN(1100)		bool _hx_tmp;
HXDLIN(1100)		if (::hx::IsNotNull( this->_hx___currentShader )) {
HXDLIN(1100)			_hx_tmp = ::hx::IsNotNull( this->_hx___currentShaderBuffer );
            		}
            		else {
HXDLIN(1100)			_hx_tmp = false;
            		}
HXDLIN(1100)		if (_hx_tmp) {
HXLINE(1102)			this->_hx___currentShader->_hx___updateFromBuffer(this->_hx___currentShaderBuffer,bufferOffset);
            		}
            	}
