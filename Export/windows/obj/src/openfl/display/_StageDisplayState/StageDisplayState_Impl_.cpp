...
HX_LOCAL_STACK_FRAME(_hx_pos_c56d6b3d9ce820b8_28_fromString,"openfl.display._StageDisplayState.StageDisplayState_Impl_","fromString",0xa44db312,"openfl.display._StageDisplayState.StageDisplayState_Impl_.fromString","openfl/display/StageDisplayState.hx",28,0x75a7a3fd)
HX_LOCAL_STACK_FRAME(_hx_pos_c56d6b3d9ce820b8_39_toString,"openfl.display._StageDisplayState.StageDisplayState_Impl_","toString",0x6b7dca23,"openfl.display._StageDisplayState.StageDisplayState_Impl_.toString","openfl/display/StageDisplayState.hx",39,0x75a7a3fd)
...
bool StageDisplayState_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic StageDisplayState_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_c56d6b3d9ce820b8_28_fromString)
...
::String StageDisplayState_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_c56d6b3d9ce820b8_39_toString)
HXDLIN(  39)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  41)			return HX_("fullScreen",5b,ae,48,2e);
HXDLIN(  41)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  42)			return HX_("fullScreenInteractive",47,df,d1,02);
HXDLIN(  42)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  43)			return HX_("normal",27,72,69,30);
...
HXDLIN(  14)		FULL_SCREEN = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_c56d6b3d9ce820b8_19_boot)
HXDLIN(  19)		FULL_SCREEN_INTERACTIVE = 1;
            	}
{
