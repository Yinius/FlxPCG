...
HX_LOCAL_STACK_FRAME(_hx_pos_187b199ba6956423_46_fromString,"openfl.display._TriangleCulling.TriangleCulling_Impl_","fromString",0x878f171c,"openfl.display._TriangleCulling.TriangleCulling_Impl_.fromString","openfl/display/TriangleCulling.hx",46,0x58d0bba2)
HX_LOCAL_STACK_FRAME(_hx_pos_187b199ba6956423_57_toString,"openfl.display._TriangleCulling.TriangleCulling_Impl_","toString",0x9ce137ad,"openfl.display._TriangleCulling.TriangleCulling_Impl_.toString","openfl/display/TriangleCulling.hx",57,0x58d0bba2)
...
bool TriangleCulling_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic TriangleCulling_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_187b199ba6956423_46_fromString)
...
::String TriangleCulling_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_187b199ba6956423_57_toString)
HXDLIN(  57)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  59)			return HX_("negative",75,26,42,51);
...
HXDLIN(  60)			goto _hx_goto_2;
            		...
            		if (  (_hx_switch_0==2) ){
HXLINE(  61)			return HX_("positive",b9,a6,fa,ca);
