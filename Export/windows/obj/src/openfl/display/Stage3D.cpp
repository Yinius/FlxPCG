...
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_543___restoreContext,"openfl.display.Stage3D","__restoreContext",0xa732262a,"openfl.display.Stage3D.__restoreContext","openfl/display/Stage3D.hx",543,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_550_get_x,"openfl.display.Stage3D","get_x",0x0609efe6,"openfl.display.Stage3D.get_x","openfl/display/Stage3D.hx",550,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_554_set_x,"openfl.display.Stage3D","set_x",0xeed8e5f2,"openfl.display.Stage3D.set_x","openfl/display/Stage3D.hx",554,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_566_get_y,"openfl.display.Stage3D","get_y",0x0609efe7,"openfl.display.Stage3D.get_y","openfl/display/Stage3D.hx",566,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_570_set_y,"openfl.display.Stage3D","set_y",0xeed8e5f3,"openfl.display.Stage3D.set_y","openfl/display/Stage3D.hx",570,0x37141b9b)
namespace openfl{
namespace display{
...
HXLINE( 532)			Float pixelRatio = this->_hx___stage->window->_hx___scale;
HXLINE( 533)			this->_hx___renderTransform->identity();
HXLINE( 534)			this->_hx___renderTransform->appendTranslation((this->_hx___x * pixelRatio),(this->_hx___y * pixelRatio),( (Float)(0) ));
HXLINE( 535)			this->_hx___renderTransform->append(this->_hx___projectionTransform);
HXLINE( 537)			this->_hx___width = width;
HXLINE( 538)			this->_hx___height = height;
            		}
            	}
...
void Stage3D_obj::_hx___restoreContext(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_543___restoreContext)
HXLINE( 544)		this->_hx___contextLost = false;
HXLINE( 545)		this->_hx___createContext();
            	}
...
Float Stage3D_obj::get_x(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_550_get_x)
HXDLIN( 550)		return this->_hx___x;
            	}
...
Float Stage3D_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_554_set_x)
HXLINE( 555)		if ((this->_hx___x == value)) {
HXLINE( 555)			return value;
            		}
HXLINE( 556)		this->_hx___x = value;
HXLINE( 557)		Float pixelRatio = this->_hx___stage->window->_hx___scale;
HXLINE( 558)		this->_hx___renderTransform->identity();
HXLINE( 559)		this->_hx___renderTransform->appendTranslation((this->_hx___x * pixelRatio),(this->_hx___y * pixelRatio),( (Float)(0) ));
HXLINE( 560)		this->_hx___renderTransform->append(this->_hx___projectionTransform);
...
Float Stage3D_obj::get_y(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_566_get_y)
HXDLIN( 566)		return this->_hx___y;
            	}
...
Float Stage3D_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_570_set_y)
HXLINE( 571)		if ((this->_hx___y == value)) {
HXLINE( 571)			return value;
            		}
HXLINE( 572)		this->_hx___y = value;
HXLINE( 573)		Float pixelRatio = this->_hx___stage->window->_hx___scale;
HXLINE( 574)		this->_hx___renderTransform->identity();
HXLINE( 575)		this->_hx___renderTransform->appendTranslation((this->_hx___x * pixelRatio),(this->_hx___y * pixelRatio),( (Float)(0) ));
HXLINE( 576)		this->_hx___renderTransform->append(this->_hx___projectionTransform);
