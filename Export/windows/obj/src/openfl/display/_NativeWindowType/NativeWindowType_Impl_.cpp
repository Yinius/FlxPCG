...
HX_LOCAL_STACK_FRAME(_hx_pos_eb95fcde744329ba_41_fromInt,"openfl.display._NativeWindowType.NativeWindowType_Impl_","fromInt",0x2473f230,"openfl.display._NativeWindowType.NativeWindowType_Impl_.fromInt","openfl/display/NativeWindowType.hx",41,0x6f707c31)
HX_LOCAL_STACK_FRAME(_hx_pos_eb95fcde744329ba_46_fromString,"openfl.display._NativeWindowType.NativeWindowType_Impl_","fromString",0x6dc04230,"openfl.display._NativeWindowType.NativeWindowType_Impl_.fromString","openfl/display/NativeWindowType.hx",46,0x6f707c31)
HX_LOCAL_STACK_FRAME(_hx_pos_eb95fcde744329ba_57_toInt,"openfl.display._NativeWindowType.NativeWindowType_Impl_","toInt",0xdd8809ff,"openfl.display._NativeWindowType.NativeWindowType_Impl_.toInt","openfl/display/NativeWindowType.hx",57,0x6f707c31)
HX_LOCAL_STACK_FRAME(_hx_pos_eb95fcde744329ba_62_toString,"openfl.display._NativeWindowType.NativeWindowType_Impl_","toString",0x55e7b5c1,"openfl.display._NativeWindowType.NativeWindowType_Impl_.toString","openfl/display/NativeWindowType.hx",62,0x6f707c31)
HX_LOCAL_STACK_FRAME(_hx_pos_eb95fcde744329ba_25_boot,"openfl.display._NativeWindowType.NativeWindowType_Impl_","boot",0x8eecfac7,"openfl.display._NativeWindowType.NativeWindowType_Impl_.boot","openfl/display/NativeWindowType.hx",25,0x6f707c31)
HX_LOCAL_STACK_FRAME(_hx_pos_eb95fcde744329ba_31_boot,"openfl.display._NativeWindowType.NativeWindowType_Impl_","boot",0x8eecfac7,"openfl.display._NativeWindowType.NativeWindowType_Impl_.boot","openfl/display/NativeWindowType.hx",31,0x6f707c31)
HX_LOCAL_STACK_FRAME(_hx_pos_eb95fcde744329ba_37_boot,"openfl.display._NativeWindowType.NativeWindowType_Impl_","boot",0x8eecfac7,"openfl.display._NativeWindowType.NativeWindowType_Impl_.boot","openfl/display/NativeWindowType.hx",37,0x6f707c31)
namespace openfl{
namespace display{
...
bool NativeWindowType_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic NativeWindowType_Impl__obj::fromInt( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_eb95fcde744329ba_41_fromInt)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(NativeWindowType_Impl__obj,fromInt,return )
 ...
 ::Dynamic NativeWindowType_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_eb95fcde744329ba_46_fromString)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(NativeWindowType_Impl__obj,fromString,return )
 ...
 ::Dynamic NativeWindowType_Impl__obj::toInt( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_eb95fcde744329ba_57_toInt)
...
::String NativeWindowType_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_eb95fcde744329ba_62_toString)
HXDLIN(  62)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  64)			return HX_("lightweight",ce,46,60,31);
HXDLIN(  64)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  65)			return HX_("normal",27,72,69,30);
HXDLIN(  65)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  66)			return HX_("utility",6c,27,7b,1f);
...
{
{
            	HX_STACKFRAME(&_hx_pos_eb95fcde744329ba_25_boot)
HXDLIN(  25)		LIGHTWEIGHT = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_eb95fcde744329ba_31_boot)
HXDLIN(  31)		NORMAL = 1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_eb95fcde744329ba_37_boot)
HXDLIN(  37)		UTILITY = 2;
            	}
}
