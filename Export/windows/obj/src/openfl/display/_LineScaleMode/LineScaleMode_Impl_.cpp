...
HX_LOCAL_STACK_FRAME(_hx_pos_ea842eab153a573b_48_fromInt,"openfl.display._LineScaleMode.LineScaleMode_Impl_","fromInt",0x4a6a68e6,"openfl.display._LineScaleMode.LineScaleMode_Impl_.fromInt","openfl/display/LineScaleMode.hx",48,0x274c8551)
HX_LOCAL_STACK_FRAME(_hx_pos_ea842eab153a573b_53_fromString,"openfl.display._LineScaleMode.LineScaleMode_Impl_","fromString",0x5d04613a,"openfl.display._LineScaleMode.LineScaleMode_Impl_.fromString","openfl/display/LineScaleMode.hx",53,0x274c8551)
HX_LOCAL_STACK_FRAME(_hx_pos_ea842eab153a573b_65_toInt,"openfl.display._LineScaleMode.LineScaleMode_Impl_","toInt",0x2c0c4735,"openfl.display._LineScaleMode.LineScaleMode_Impl_.toInt","openfl/display/LineScaleMode.hx",65,0x274c8551)
HX_LOCAL_STACK_FRAME(_hx_pos_ea842eab153a573b_70_toString,"openfl.display._LineScaleMode.LineScaleMode_Impl_","toString",0x67991e4b,"openfl.display._LineScaleMode.LineScaleMode_Impl_.toString","openfl/display/LineScaleMode.hx",70,0x274c8551)
...
bool LineScaleMode_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic LineScaleMode_Impl__obj::fromInt( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_ea842eab153a573b_48_fromInt)
HXDLIN(  48)		return value;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LineScaleMode_Impl__obj,fromInt,return )
 ...
 ::Dynamic LineScaleMode_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_ea842eab153a573b_53_fromString)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LineScaleMode_Impl__obj,fromString,return )
 ...
 ::Dynamic LineScaleMode_Impl__obj::toInt( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_ea842eab153a573b_65_toInt)
...
::String LineScaleMode_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_ea842eab153a573b_70_toString)
HXDLIN(  70)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  72)			return HX_("horizontal",e4,fc,c3,15);
HXDLIN(  72)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  73)			return HX_("none",b8,12,0a,49);
HXDLIN(  73)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  74)			return HX_("normal",27,72,69,30);
HXDLIN(  74)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==3) ){
HXLINE(  75)			return HX_("vertical",76,bc,15,6a);
