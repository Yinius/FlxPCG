...
HX_LOCAL_STACK_FRAME(_hx_pos_0f3cf3c73141d162_38_fromString,"openfl.display._PixelSnapping.PixelSnapping_Impl_","fromString",0xc7730368,"openfl.display._PixelSnapping.PixelSnapping_Impl_.fromString","openfl/display/PixelSnapping.hx",38,0x71d03308)
HX_LOCAL_STACK_FRAME(_hx_pos_0f3cf3c73141d162_49_toString,"openfl.display._PixelSnapping.PixelSnapping_Impl_","toString",0xd1c938f9,"openfl.display._PixelSnapping.PixelSnapping_Impl_.toString","openfl/display/PixelSnapping.hx",49,0x71d03308)
...
bool PixelSnapping_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic PixelSnapping_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_0f3cf3c73141d162_38_fromString)
...
::String PixelSnapping_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_0f3cf3c73141d162_49_toString)
HXDLIN(  49)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  51)			return HX_("always",cf,0e,d7,46);
HXDLIN(  51)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  52)			return HX_("auto",6f,df,76,40);
HXDLIN(  52)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  53)			return HX_("never",8c,3e,30,99);
