...
HX_LOCAL_STACK_FRAME(_hx_pos_9f809a2b617ac4f8_53_fromString,"openfl.display._StageAlign.StageAlign_Impl_","fromString",0x4e30c8b0,"openfl.display._StageAlign.StageAlign_Impl_.fromString","openfl/display/StageAlign.hx",53,0x49ee790b)
HX_LOCAL_STACK_FRAME(_hx_pos_9f809a2b617ac4f8_69_toString,"openfl.display._StageAlign.StageAlign_Impl_","toString",0xe3319c41,"openfl.display._StageAlign.StageAlign_Impl_.toString","openfl/display/StageAlign.hx",69,0x49ee790b)
...
bool StageAlign_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic StageAlign_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_9f809a2b617ac4f8_53_fromString)
...
::String StageAlign_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_9f809a2b617ac4f8_69_toString)
HXDLIN(  69)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  71)			return HX_("bottom",eb,e6,78,65);
HXDLIN(  71)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  72)			return HX_("bottomLeft",92,6c,97,2c);
HXDLIN(  72)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  73)			return HX_("bottomRight",f1,a0,f4,4e);
...
HXDLIN(  75)			goto _hx_goto_2;
            		...
            		if (  (_hx_switch_0==5) ){
HXLINE(  76)			return HX_("top",95,66,58,00);
HXDLIN(  76)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==6) ){
HXLINE(  77)			return HX_("topLeft",3c,09,c1,e8);
HXDLIN(  77)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==7) ){
HXLINE(  78)			return HX_("topRight",07,19,34,37);
