...
HX_LOCAL_STACK_FRAME(_hx_pos_239e25a9d59ce7b2_54_fromString,"openfl.display._ShaderPrecision.ShaderPrecision_Impl_","fromString",0xa4b5053a,"openfl.display._ShaderPrecision.ShaderPrecision_Impl_.fromString","openfl/display/ShaderPrecision.hx",54,0xf4519f71)
HX_LOCAL_STACK_FRAME(_hx_pos_239e25a9d59ce7b2_64_toString,"openfl.display._ShaderPrecision.ShaderPrecision_Impl_","toString",0x9518c24b,"openfl.display._ShaderPrecision.ShaderPrecision_Impl_.toString","openfl/display/ShaderPrecision.hx",64,0xf4519f71)
HX_LOCAL_STACK_FRAME(_hx_pos_239e25a9d59ce7b2_40_boot,"openfl.display._ShaderPrecision.ShaderPrecision_Impl_","boot",0xa4a67a51,"openfl.display._ShaderPrecision.ShaderPrecision_Impl_.boot","openfl/display/ShaderPrecision.hx",40,0xf4519f71)
HX_LOCAL_STACK_FRAME(_hx_pos_239e25a9d59ce7b2_50_boot,"openfl.display._ShaderPrecision.ShaderPrecision_Impl_","boot",0xa4a67a51,"openfl.display._ShaderPrecision.ShaderPrecision_Impl_.boot","openfl/display/ShaderPrecision.hx",50,0xf4519f71)
namespace openfl{
namespace display{
...
bool ShaderPrecision_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic ShaderPrecision_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_239e25a9d59ce7b2_54_fromString)
...
::String ShaderPrecision_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_239e25a9d59ce7b2_64_toString)
HXDLIN(  64)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  67)			return HX_("fast",9c,c2,b5,43);
HXDLIN(  67)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  66)			return HX_("full",8f,e9,c4,43);
...
{
{
            	HX_STACKFRAME(&_hx_pos_239e25a9d59ce7b2_40_boot)
HXDLIN(  40)		FAST = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_239e25a9d59ce7b2_50_boot)
HXDLIN(  50)		FULL = 1;
            	}
}
