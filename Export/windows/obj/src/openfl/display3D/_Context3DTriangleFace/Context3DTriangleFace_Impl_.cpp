...
HX_LOCAL_STACK_FRAME(_hx_pos_c6faaa6b9f0fc2b9_21_fromString,"openfl.display3D._Context3DTriangleFace.Context3DTriangleFace_Impl_","fromString",0x04ef1c93,"openfl.display3D._Context3DTriangleFace.Context3DTriangleFace_Impl_.fromString","openfl/display3D/Context3DTriangleFace.hx",21,0x186e7db4)
HX_LOCAL_STACK_FRAME(_hx_pos_c6faaa6b9f0fc2b9_33_toString,"openfl.display3D._Context3DTriangleFace.Context3DTriangleFace_Impl_","toString",0xd6ea2164,"openfl.display3D._Context3DTriangleFace.Context3DTriangleFace_Impl_.toString","openfl/display3D/Context3DTriangleFace.hx",33,0x186e7db4)
...
bool Context3DTriangleFace_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Context3DTriangleFace_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_c6faaa6b9f0fc2b9_21_fromString)
...
::String Context3DTriangleFace_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_c6faaa6b9f0fc2b9_33_toString)
HXDLIN(  33)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  35)			return HX_("back",27,da,10,41);
HXDLIN(  35)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  36)			return HX_("front",a9,18,8e,06);
HXDLIN(  36)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  37)			return HX_("frontAndBack",f5,1e,63,ce);
HXDLIN(  37)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==3) ){
HXLINE(  38)			return HX_("none",b8,12,0a,49);
