...
HXLINE( 867)		sr->f = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,60),( (::cpp::Int64)(15) )));
HXLINE( 868)		sr->m = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,56),( (::cpp::Int64)(15) )));
HXLINE( 869)		sr->w = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,52),( (::cpp::Int64)(15) )));
HXLINE( 870)		sr->s = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,48),( (::cpp::Int64)(15) )));
HXLINE( 871)		sr->d = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,44),( (::cpp::Int64)(15) )));
HXLINE( 872)		sr->t = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,40),( (::cpp::Int64)(15) )));
HXLINE( 873)		sr->type = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,32),( (::cpp::Int64)(15) )));
HXLINE( 874)		sr->b = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,16),( (::cpp::Int64)(255) )));
HXLINE( 875)		sr->n = _hx_int64_low(_hx_int64_and(v,( (::cpp::Int64)(65535) )));
