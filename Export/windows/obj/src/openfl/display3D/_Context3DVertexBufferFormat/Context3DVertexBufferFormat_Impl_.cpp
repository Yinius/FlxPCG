...
HX_LOCAL_STACK_FRAME(_hx_pos_512538a9b8c6e1ed_22_fromString,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_","fromString",0x69b9a727,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_.fromString","openfl/display3D/Context3DVertexBufferFormat.hx",22,0x4ab2835e)
HX_LOCAL_STACK_FRAME(_hx_pos_512538a9b8c6e1ed_35_toString,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_","toString",0xa34b1ef8,"openfl.display3D._Context3DVertexBufferFormat.Context3DVertexBufferFormat_Impl_.toString","openfl/display3D/Context3DVertexBufferFormat.hx",35,0x4ab2835e)
...
bool Context3DVertexBufferFormat_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Context3DVertexBufferFormat_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_512538a9b8c6e1ed_22_fromString)
...
::String Context3DVertexBufferFormat_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_512538a9b8c6e1ed_35_toString)
HXDLIN(  35)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  37)			return HX_("bytes4",69,55,6f,27);
HXDLIN(  37)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  38)			return HX_("float1",15,23,56,41);
HXDLIN(  38)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  39)			return HX_("float2",16,23,56,41);
HXDLIN(  39)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==3) ){
HXLINE(  40)			return HX_("float3",17,23,56,41);
HXDLIN(  40)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==4) ){
HXLINE(  41)			return HX_("float4",18,23,56,41);
