...
HX_LOCAL_STACK_FRAME(_hx_pos_af97a71a2edef249_24_fromString,"openfl.net._SharedObjectFlushStatus.SharedObjectFlushStatus_Impl_","fromString",0x2501bd23,"openfl.net._SharedObjectFlushStatus.SharedObjectFlushStatus_Impl_.fromString","openfl/net/SharedObjectFlushStatus.hx",24,0x3756667d)
HX_LOCAL_STACK_FRAME(_hx_pos_af97a71a2edef249_34_toString,"openfl.net._SharedObjectFlushStatus.SharedObjectFlushStatus_Impl_","toString",0x6f407df4,"openfl.net._SharedObjectFlushStatus.SharedObjectFlushStatus_Impl_.toString","openfl/net/SharedObjectFlushStatus.hx",34,0x3756667d)
...
bool SharedObjectFlushStatus_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic SharedObjectFlushStatus_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_af97a71a2edef249_24_fromString)
...
::String SharedObjectFlushStatus_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_af97a71a2edef249_34_toString)
HXDLIN(  34)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  36)			return HX_("flushed",23,f4,4c,6a);
HXDLIN(  36)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  37)			return HX_("pending",57,98,ec,2b);
