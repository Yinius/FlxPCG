...
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_519_updateAfterEvent,"openfl.events.TouchEvent","updateAfterEvent",0xeb0abce3,"openfl.events.TouchEvent.updateAfterEvent","openfl/events/TouchEvent.hx",519,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_534___init,"openfl.events.TouchEvent","__init",0x9cbf244c,"openfl.events.TouchEvent.__init","openfl/events/TouchEvent.hx",534,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_524___create,"openfl.events.TouchEvent","__create",0x8acd1738,"openfl.events.TouchEvent.__create","openfl/events/TouchEvent.hx",524,0x2fe85d0c)
...
void TouchEvent_obj::updateAfterEvent(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_519_updateAfterEvent)
HXDLIN( 519)		this->_hx___updateAfterEventFlag = true;
            	}
...
void TouchEvent_obj::_hx___init(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_534___init)
HXLINE( 535)		this->super::_hx___init();
HXLINE( 536)		this->bubbles = true;
HXLINE( 537)		this->touchPointID = 0;
HXLINE( 538)		this->isPrimaryTouchPoint = false;
HXLINE( 539)		this->localX = ( (Float)(0) );
HXLINE( 540)		this->localY = ( (Float)(0) );
HXLINE( 541)		this->sizeX = ( (Float)(0) );
HXLINE( 542)		this->sizeY = ( (Float)(0) );
HXLINE( 543)		this->pressure = ( (Float)(0) );
HXLINE( 544)		this->relatedObject = null();
HXLINE( 545)		this->ctrlKey = false;
HXLINE( 546)		this->altKey = false;
HXLINE( 547)		this->shiftKey = false;
HXLINE( 548)		this->commandKey = false;
HXLINE( 549)		this->controlKey = false;
HXLINE( 551)		this->stageX = ::Math_obj::NaN;
HXLINE( 552)		this->stageY = ::Math_obj::NaN;
HXLINE( 554)		this->_hx___updateAfterEventFlag = false;
            	}
...
::String TouchEvent_obj::TOUCH_TAP;
 ...
 ::openfl::events::TouchEvent TouchEvent_obj::_hx___create(::String type, ::Dynamic touch,Float stageX,Float stageY, ::openfl::geom::Point local, ::openfl::display::InteractiveObject target){
            	HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_524___create)
HXLINE( 525)		 ::openfl::events::TouchEvent evt =  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,type,true,false,0,true,local->x,local->y,1,1,1,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 526)		evt->stageX = stageX;
HXLINE( 527)		evt->stageY = stageY;
HXLINE( 528)		evt->target = target;
HXLINE( 530)		return evt;
            	}
