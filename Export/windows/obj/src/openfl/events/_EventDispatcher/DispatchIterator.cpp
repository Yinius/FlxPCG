...
HX_DEFINE_STACK_FRAME(_hx_pos_eed9e911a94343be_541_new,"openfl.events._EventDispatcher.DispatchIterator","new",0x76c2678f,"openfl.events._EventDispatcher.DispatchIterator.new","openfl/events/EventDispatcher.hx",541,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_548_copy,"openfl.events._EventDispatcher.DispatchIterator","copy",0x6c1a6da6,"openfl.events._EventDispatcher.DispatchIterator.copy","openfl/events/EventDispatcher.hx",548,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_557_hasNext,"openfl.events._EventDispatcher.DispatchIterator","hasNext",0xef22001c,"openfl.events._EventDispatcher.DispatchIterator.hasNext","openfl/events/EventDispatcher.hx",557,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_562_next,"openfl.events._EventDispatcher.DispatchIterator","next",0x735836e4,"openfl.events._EventDispatcher.DispatchIterator.next","openfl/events/EventDispatcher.hx",562,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_567_remove,"openfl.events._EventDispatcher.DispatchIterator","remove",0xb5236c75,"openfl.events._EventDispatcher.DispatchIterator.remove","openfl/events/EventDispatcher.hx",567,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_591_reset,"openfl.events._EventDispatcher.DispatchIterator","reset",0xc76e4abe,"openfl.events._EventDispatcher.DispatchIterator.reset","openfl/events/EventDispatcher.hx",591,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_600_start,"openfl.events._EventDispatcher.DispatchIterator","start",0x64b17551,"openfl.events._EventDispatcher.DispatchIterator.start","openfl/events/EventDispatcher.hx",600,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_605_stop,"openfl.events._EventDispatcher.DispatchIterator","stop",0x76b1a1f3,"openfl.events._EventDispatcher.DispatchIterator.stop","openfl/events/EventDispatcher.hx",605,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_532_boot,"openfl.events._EventDispatcher.DispatchIterator","boot",0x6b713623,"openfl.events._EventDispatcher.DispatchIterator.boot","openfl/events/EventDispatcher.hx",532,0xe2270714)
namespace openfl{
namespace events{
namespace _EventDispatcher{

void DispatchIterator_obj::__construct(::Array< ::Dynamic> list){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_541_new)
HXLINE( 542)		this->active = false;
HXLINE( 543)		this->reset(list);
            	}
...
void DispatchIterator_obj::copy(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_548_copy)
HXDLIN( 548)		if (!(this->isCopy)) {
HXLINE( 550)			this->list = this->list->copy();
HXLINE( 551)			this->isCopy = true;
            		}
            	}
...
bool DispatchIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_557_hasNext)
HXDLIN( 557)		return (this->index < this->list->length);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(DispatchIterator_obj,hasNext,return )
 ...
 ::openfl::events::_EventDispatcher::Listener DispatchIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_562_next)
HXDLIN( 562)		return this->list->__get(this->index++).StaticCast<  ::openfl::events::_EventDispatcher::Listener >();
            	}
...
void DispatchIterator_obj::remove( ::openfl::events::_EventDispatcher::Listener listener,int listIndex){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_567_remove)
HXDLIN( 567)		if (this->active) {
HXLINE( 569)			if (!(this->isCopy)) {
HXLINE( 571)				if ((listIndex < this->index)) {
HXLINE( 573)					this->index--;
            				}
            			}
            			else {
HXLINE( 578)				int _g = this->index;
HXDLIN( 578)				int _g1 = this->list->length;
HXDLIN( 578)				while((_g < _g1)){
HXLINE( 578)					_g = (_g + 1);
HXDLIN( 578)					int i = (_g - 1);
HXLINE( 580)					if (::hx::IsInstanceEq( this->list->__get(i).StaticCast<  ::openfl::events::_EventDispatcher::Listener >(),listener )) {
HXLINE( 582)						this->list->removeRange(i,1);
HXLINE( 583)						goto _hx_goto_4;
            					}
            				}
            				_hx_goto_4:;
            			}
...
void DispatchIterator_obj::reset(::Array< ::Dynamic> list){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_591_reset)
HXLINE( 592)		this->list = list;
HXLINE( 594)		this->isCopy = false;
HXLINE( 595)		this->index = 0;
            	}
...
void DispatchIterator_obj::start(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_600_start)
HXDLIN( 600)		this->active = true;
            	}
...
void DispatchIterator_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_605_stop)
HXDLIN( 605)		this->active = false;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_532_boot)
HXDLIN( 532)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
