...
HX_DEFINE_STACK_FRAME(_hx_pos_4056b9d72619ced0_628_new,"openfl.events._EventDispatcher.Listener","new",0x63be323b,"openfl.events._EventDispatcher.Listener.new","openfl/events/EventDispatcher.hx",628,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_4056b9d72619ced0_651_match,"openfl.events._EventDispatcher.Listener","match",0xdf4e17e0,"openfl.events._EventDispatcher.Listener.match","openfl/events/EventDispatcher.hx",651,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_4056b9d72619ced0_614_boot,"openfl.events._EventDispatcher.Listener","boot",0xdac6c1f7,"openfl.events._EventDispatcher.Listener.boot","openfl/events/EventDispatcher.hx",614,0xe2270714)
namespace openfl{
namespace events{
...
void Listener_obj::__construct( ::Dynamic callback,bool useCapture,int priority,bool useWeakReference){
            	HX_STACKFRAME(&_hx_pos_4056b9d72619ced0_628_new)
HXLINE( 643)		this->callback = callback;
HXLINE( 645)		this->useCapture = useCapture;
HXLINE( 646)		this->priority = priority;
HXLINE( 647)		this->useWeakReference = useWeakReference;
            	}
...
bool Listener_obj::match( ::Dynamic callback,bool useCapture){
            	HX_STACKFRAME(&_hx_pos_4056b9d72619ced0_651_match)
HXLINE( 652)		 ::Dynamic resolvedCallback = this->callback;
HXLINE( 667)		if (::Reflect_obj::compareMethods(resolvedCallback,callback)) {
HXLINE( 667)			return (this->useCapture == useCapture);
            		}
            		else {
HXLINE( 667)			return false;
            		}
HXDLIN( 667)		return false;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_4056b9d72619ced0_614_boot)
HXDLIN( 614)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
