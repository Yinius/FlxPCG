...
HX_LOCAL_STACK_FRAME(_hx_pos_31a37265e1649dc6_43_fromString,"openfl.text._GridFitType.GridFitType_Impl_","fromString",0xec7a2309,"openfl.text._GridFitType.GridFitType_Impl_.fromString","openfl/text/GridFitType.hx",43,0x99326c1c)
HX_LOCAL_STACK_FRAME(_hx_pos_31a37265e1649dc6_54_toString,"openfl.text._GridFitType.GridFitType_Impl_","toString",0x85ab7e5a,"openfl.text._GridFitType.GridFitType_Impl_.toString","openfl/text/GridFitType.hx",54,0x99326c1c)
HX_LOCAL_STACK_FRAME(_hx_pos_31a37265e1649dc6_18_boot,"openfl.text._GridFitType.GridFitType_Impl_","boot",0xa66842e0,"openfl.text._GridFitType.GridFitType_Impl_.boot","openfl/text/GridFitType.hx",18,0x99326c1c)
HX_LOCAL_STACK_FRAME(_hx_pos_31a37265e1649dc6_28_boot,"openfl.text._GridFitType.GridFitType_Impl_","boot",0xa66842e0,"openfl.text._GridFitType.GridFitType_Impl_.boot","openfl/text/GridFitType.hx",28,0x99326c1c)
HX_LOCAL_STACK_FRAME(_hx_pos_31a37265e1649dc6_39_boot,"openfl.text._GridFitType.GridFitType_Impl_","boot",0xa66842e0,"openfl.text._GridFitType.GridFitType_Impl_.boot","openfl/text/GridFitType.hx",39,0x99326c1c)
namespace openfl{
namespace text{
...
bool GridFitType_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic GridFitType_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_31a37265e1649dc6_43_fromString)
...
::String GridFitType_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_31a37265e1649dc6_54_toString)
...
HXDLIN(  56)			goto _hx_goto_2;
            		...
            		if (  (_hx_switch_0==1) ){
HXLINE(  57)			return HX_("pixel",86,c6,a3,c2);
HXDLIN(  57)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  58)			return HX_("subpixel",06,ad,95,a4);
...
{
{
            	HX_STACKFRAME(&_hx_pos_31a37265e1649dc6_18_boot)
HXDLIN(  18)		NONE = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_31a37265e1649dc6_28_boot)
HXDLIN(  28)		PIXEL = 1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_31a37265e1649dc6_39_boot)
HXDLIN(  39)		SUBPIXEL = 2;
            	}
}
