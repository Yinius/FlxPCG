...
HX_LOCAL_STACK_FRAME(_hx_pos_52c40939c4ee2936_53_fromString,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_","fromString",0xac8d25d1,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_.fromString","openfl/text/TextFormatAlign.hx",53,0xaa546dc0)
HX_LOCAL_STACK_FRAME(_hx_pos_52c40939c4ee2936_67_toString,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_","toString",0xf3d6bf22,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_.toString","openfl/text/TextFormatAlign.hx",67,0xaa546dc0)
...
HX_LOCAL_STACK_FRAME(_hx_pos_52c40939c4ee2936_41_boot,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_","boot",0x91217fa8,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_.boot","openfl/text/TextFormatAlign.hx",41,0xaa546dc0)
HX_LOCAL_STACK_FRAME(_hx_pos_52c40939c4ee2936_49_boot,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_","boot",0x91217fa8,"openfl.text._TextFormatAlign.TextFormatAlign_Impl_.boot","openfl/text/TextFormatAlign.hx",49,0xaa546dc0)
namespace openfl{
namespace text{
...
bool TextFormatAlign_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic TextFormatAlign_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_52c40939c4ee2936_53_fromString)
...
::String TextFormatAlign_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_52c40939c4ee2936_67_toString)
HXDLIN(  67)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  69)			return HX_("center",d5,25,db,05);
HXDLIN(  69)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  70)			return HX_("end",db,03,4d,00);
HXDLIN(  70)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  71)			return HX_("justify",50,df,b5,83);
HXDLIN(  71)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==3) ){
HXLINE(  72)			return HX_("left",07,08,b0,47);
HXDLIN(  72)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==4) ){
HXLINE(  73)			return HX_("right",dc,0b,64,e9);
HXDLIN(  73)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==5) ){
HXLINE(  74)			return HX_("start",62,74,0b,84);
...
{
            	HX_STACKFRAME(&_hx_pos_52c40939c4ee2936_41_boot)
HXDLIN(  41)		RIGHT = 4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_52c40939c4ee2936_49_boot)
HXDLIN(  49)		START = 5;
            	}
}
