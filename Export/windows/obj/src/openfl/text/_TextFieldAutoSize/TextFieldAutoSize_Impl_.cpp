...
HX_LOCAL_STACK_FRAME(_hx_pos_3979b3584d4ecefb_39_fromString,"openfl.text._TextFieldAutoSize.TextFieldAutoSize_Impl_","fromString",0xeb62d059,"openfl.text._TextFieldAutoSize.TextFieldAutoSize_Impl_.fromString","openfl/text/TextFieldAutoSize.hx",39,0x2bbbb0a4)
HX_LOCAL_STACK_FRAME(_hx_pos_3979b3584d4ecefb_51_toString,"openfl.text._TextFieldAutoSize.TextFieldAutoSize_Impl_","toString",0x3f3737aa,"openfl.text._TextFieldAutoSize.TextFieldAutoSize_Impl_.toString","openfl/text/TextFieldAutoSize.hx",51,0x2bbbb0a4)
...
bool TextFieldAutoSize_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic TextFieldAutoSize_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_3979b3584d4ecefb_39_fromString)
...
::String TextFieldAutoSize_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_3979b3584d4ecefb_51_toString)
HXDLIN(  51)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  53)			return HX_("center",d5,25,db,05);
HXDLIN(  53)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  54)			return HX_("left",07,08,b0,47);
HXDLIN(  54)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  55)			return HX_("none",b8,12,0a,49);
HXDLIN(  55)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==3) ){
HXLINE(  56)			return HX_("right",dc,0b,64,e9);
