...
HX_LOCAL_STACK_FRAME(_hx_pos_55d16bca45175189_70_fromString,"openfl.text._FontType.FontType_Impl_","fromString",0x1af62497,"openfl.text._FontType.FontType_Impl_.fromString","openfl/text/FontType.hx",70,0xc9ae6f12)
HX_LOCAL_STACK_FRAME(_hx_pos_55d16bca45175189_81_toString,"openfl.text._FontType.FontType_Impl_","toString",0xa3a06068,"openfl.text._FontType.FontType_Impl_.toString","openfl/text/FontType.hx",81,0xc9ae6f12)
...
HX_LOCAL_STACK_FRAME(_hx_pos_55d16bca45175189_66_boot,"openfl.text._FontType.FontType_Impl_","boot",0xc26385ee,"openfl.text._FontType.FontType_Impl_.boot","openfl/text/FontType.hx",66,0xc9ae6f12)
namespace openfl{
namespace text{
namespace _FontType{
...
bool FontType_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic FontType_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_55d16bca45175189_70_fromString)
HXDLIN(  70)		::String _hx_switch_0 = value;
...
::String FontType_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_55d16bca45175189_81_toString)
HXDLIN(  81)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  83)			return HX_("device",96,dc,77,71);
HXDLIN(  83)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  84)			return HX_("embedded",8a,19,62,de);
HXDLIN(  84)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  85)			return HX_("embeddedCFF",f9,0c,9e,ac);
...
HXDLIN(  46)		EMBEDDED = 1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_55d16bca45175189_66_boot)
HXDLIN(  66)		EMBEDDED_CFF = 2;
            	}
}
