...
HX_DEFINE_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_30_new,"openfl.text._internal.TextLayout","new",0xa41075de,"openfl.text._internal.TextLayout.new","openfl/text/_internal/TextLayout.hx",30,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_123___create,"openfl.text._internal.TextLayout","__create",0xba8383de,"openfl.text._internal.TextLayout.__create","openfl/text/_internal/TextLayout.hx",123,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_135___position,"openfl.text._internal.TextLayout","__position",0xa4593a0b,"openfl.text._internal.TextLayout.__position","openfl/text/_internal/TextLayout.hx",135,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_245_get_positions,"openfl.text._internal.TextLayout","get_positions",0x810b767f,"openfl.text._internal.TextLayout.get_positions","openfl/text/_internal/TextLayout.hx",245,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_257_get_direction,"openfl.text._internal.TextLayout","get_direction",0xc0f9e514,"openfl.text._internal.TextLayout.get_direction","openfl/text/_internal/TextLayout.hx",257,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_261_set_direction,"openfl.text._internal.TextLayout","set_direction",0x05ffc720,"openfl.text._internal.TextLayout.set_direction","openfl/text/_internal/TextLayout.hx",261,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_271_set_font,"openfl.text._internal.TextLayout","set_font",0x081d248e,"openfl.text._internal.TextLayout.set_font","openfl/text/_internal/TextLayout.hx",271,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_282_get_glyphs,"openfl.text._internal.TextLayout","get_glyphs",0xd5068f52,"openfl.text._internal.TextLayout.get_glyphs","openfl/text/_internal/TextLayout.hx",282,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_295_get_language,"openfl.text._internal.TextLayout","get_language",0xd7d8ef23,"openfl.text._internal.TextLayout.get_language","openfl/text/_internal/TextLayout.hx",295,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_299_set_language,"openfl.text._internal.TextLayout","set_language",0xecd21297,"openfl.text._internal.TextLayout.set_language","openfl/text/_internal/TextLayout.hx",299,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_310_get_script,"openfl.text._internal.TextLayout","get_script",0x6e0de416,"openfl.text._internal.TextLayout.get_script","openfl/text/_internal/TextLayout.hx",310,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_314_set_script,"openfl.text._internal.TextLayout","set_script",0x718b828a,"openfl.text._internal.TextLayout.set_script","openfl/text/_internal/TextLayout.hx",314,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_324_set_size,"openfl.text._internal.TextLayout","set_size",0x10b06780,"openfl.text._internal.TextLayout.set_size","openfl/text/_internal/TextLayout.hx",324,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_333_set_text,"openfl.text._internal.TextLayout","set_text",0x1156936c,"openfl.text._internal.TextLayout.set_text","openfl/text/_internal/TextLayout.hx",333,0xf9c6f251)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_51_boot,"openfl.text._internal.TextLayout","boot",0xe26facf4,"openfl.text._internal.TextLayout.boot","openfl/text/_internal/TextLayout.hx",51,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_52_boot,"openfl.text._internal.TextLayout","boot",0xe26facf4,"openfl.text._internal.TextLayout.boot","openfl/text/_internal/TextLayout.hx",52,0xf9c6f251)
namespace openfl{
namespace text{
namespace _internal{
...
void TextLayout_obj::__construct(::String __o_text, ::lime::text::Font font,::hx::Null< int >  __o_size,::hx::Null< int >  __o_direction,::String __o_script,::String __o_language){
            	...
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_30_new)
HXLINE(  77)		this->_hx___hbFontSize = -1;
HXLINE(  62)		this->letterSpacing = ((Float)0);
HXLINE(  82)		this->set_text(text);
HXLINE(  83)		this->set_font(font);
HXLINE(  84)		this->set_size(size);
HXLINE(  85)		this->_hx___direction = direction;
HXLINE(  86)		this->_hx___script = script;
HXLINE(  87)		this->_hx___language = language;
HXLINE(  89)		this->positions = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  90)		this->_hx___dirty = true;
HXLINE(  92)		this->_hx___create(this->_hx___direction,this->_hx___script,this->_hx___language);
            	}
...
void TextLayout_obj::_hx___create(int direction,::String script,::String language){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_123___create)
HXLINE( 124)		if ((language.length != 4)) {
HXLINE( 124)			return;
            		}
HXLINE( 127)		this->_hx___hbBuffer = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::_new();
HXLINE( 128)		{
HXLINE( 128)			 ::Dynamic this1 = this->_hx___hbBuffer;
HXDLIN( 128)			int value;
HXDLIN( 128)			switch((int)(direction)){
            				case (int)4: {
HXLINE( 128)					value = 4;
            				}
            				break;
...
HXDLIN( 128)			::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_direction(::hx::DynamicPtr(this1),value);
            		}
HXLINE( 129)		{
HXLINE( 129)			int value1 = (int)1517910393;
HXDLIN( 129)			::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_script(::hx::DynamicPtr(this->_hx___hbBuffer),value1);
            		}
HXLINE( 130)		{
HXLINE( 130)			 ::Dynamic this2 = this->_hx___hbBuffer;
HXDLIN( 130)			 ::Dynamic value2 = ::lime::text::harfbuzz::_HBLanguage::HBLanguage_Impl__obj::_new(language);
HXDLIN( 130)			::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_language(::hx::DynamicPtr(this2),::hx::DynamicPtr(value2));
            		}
            	}
...
void TextLayout_obj::_hx___position(){
            	HX_GC_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_135___position)
HXLINE( 136)		this->positions = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 139)		bool _hx_tmp;
HXDLIN( 139)		bool _hx_tmp1;
HXDLIN( 139)		bool _hx_tmp2;
HXDLIN( 139)		if (::hx::IsNotNull( this->text )) {
HXLINE( 139)			_hx_tmp2 = (this->text != HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 139)			_hx_tmp2 = false;
            		}
HXDLIN( 139)		if (_hx_tmp2) {
HXLINE( 139)			_hx_tmp1 = ::hx::IsNotNull( this->font );
            		}
            		else {
HXLINE( 139)			_hx_tmp1 = false;
            		}
HXDLIN( 139)		if (_hx_tmp1) {
HXLINE( 139)			_hx_tmp = ::hx::IsNotNull( this->font->src );
            		}
            		else {
HXLINE( 139)			_hx_tmp = false;
            		}
HXDLIN( 139)		if (_hx_tmp) {
HXLINE( 141)			if (::hx::IsNull( this->_hx___buffer )) {
HXLINE( 143)				this->_hx___buffer = ::haxe::io::Bytes_obj::alloc((this->text.length * 5));
            			}
HXLINE( 149)			bool _hx_tmp3;
HXDLIN( 149)			if (::hx::IsInstanceEq( this->_hx___font,this->font )) {
HXLINE( 149)				_hx_tmp3 = (this->_hx___hbFontSize != this->size);
            			}
            			else {
HXLINE( 149)				_hx_tmp3 = true;
            			}
HXDLIN( 149)			if (_hx_tmp3) {
HXLINE( 151)				this->_hx___font = this->font;
HXLINE( 153)				this->font->_hx___setSize(this->size,null());
HXLINE( 154)				this->_hx___hbFont = ::lime::text::harfbuzz::_HBFTFont::HBFTFont_Impl__obj::_new(this->font);
HXLINE( 155)				this->_hx___hbFontSize = this->size;
HXLINE( 157)				if (this->autoHint) {
HXLINE( 162)					::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_ft_font_set_load_flags(::hx::DynamicPtr(this->_hx___hbFont),0);
            				}
            			}
            			else {
HXLINE( 171)				this->font->_hx___setSize(this->size,null());
            			}
HXLINE( 174)			if (::hx::IsNull( this->_hx___hbBuffer )) {
HXLINE( 176)				this->_hx___hbBuffer = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::_new();
            			}
            			else {
HXLINE( 180)				::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::reset(this->_hx___hbBuffer);
            			}
HXLINE( 183)			{
HXLINE( 183)				 ::Dynamic this1 = this->_hx___hbBuffer;
HXDLIN( 183)				int value;
HXDLIN( 183)				switch((int)(this->get_direction())){
            					case (int)4: {
HXLINE( 183)						value = 4;
            					}
            					break;
...
HXDLIN( 183)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_direction(::hx::DynamicPtr(this1),value);
            			}
HXLINE( 184)			{
HXLINE( 184)				 ::Dynamic this2 = this->_hx___hbBuffer;
HXDLIN( 184)				::String this3 = this->get_script();
HXDLIN( 184)				int value1 = (int)1517910393;
HXDLIN( 184)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_script(::hx::DynamicPtr(this2),value1);
            			}
HXLINE( 185)			{
HXLINE( 185)				 ::Dynamic this4 = this->_hx___hbBuffer;
HXDLIN( 185)				 ::Dynamic value2 = ::lime::text::harfbuzz::_HBLanguage::HBLanguage_Impl__obj::_new(this->get_language());
HXDLIN( 185)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_language(::hx::DynamicPtr(this4),::hx::DynamicPtr(value2));
            			}
HXLINE( 186)			{
HXLINE( 186)				int value3 = 2;
HXDLIN( 186)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_cluster_level(::hx::DynamicPtr(this->_hx___hbBuffer),value3);
            			}
HXLINE( 198)			 ::Dynamic _hx_tmp4 = this->_hx___hbBuffer;
HXDLIN( 198)			Float _hx_tmp5 = (uintptr_t)this->text.wc_str();
HXDLIN( 198)			::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::addUTF16(_hx_tmp4,_hx_tmp5,this->text.length,0,-1);
HXLINE( 209)			::lime::text::harfbuzz::HB_obj::shape(this->_hx___hbFont,this->_hx___hbBuffer,null());
HXLINE( 211)			::Array< ::Dynamic> _info = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphInfo(this->_hx___hbBuffer);
HXLINE( 212)			::Array< ::Dynamic> _positions = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphPositions(this->_hx___hbBuffer);
HXLINE( 214)			bool _hx_tmp6;
HXDLIN( 214)			if (::hx::IsNotNull( _info )) {
HXLINE( 214)				_hx_tmp6 = ::hx::IsNotNull( _positions );
            			}
            			else {
HXLINE( 214)				_hx_tmp6 = false;
            			}
HXDLIN( 214)			if (_hx_tmp6) {
HXLINE( 216)				 ::lime::text::harfbuzz::HBGlyphInfo info;
HXLINE( 217)				 ::lime::text::harfbuzz::HBGlyphPosition position;
HXLINE( 218)				int lastCluster = -1;
HXLINE( 220)				int length = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(_info->length) ),( (Float)(_positions->length) )));
HXLINE( 222)				{
HXLINE( 222)					int _g = 0;
...
HXLINE( 224)						info = _info->__get(i).StaticCast<  ::lime::text::harfbuzz::HBGlyphInfo >();
HXLINE( 225)						position = _positions->__get(i).StaticCast<  ::lime::text::harfbuzz::HBGlyphPosition >();
HXLINE( 227)						{
HXLINE( 227)							int _g2 = (lastCluster + 1);
HXDLIN( 227)							int _g3 = info->cluster;
HXDLIN( 227)							while((_g2 < _g3)){
HXLINE( 227)								_g2 = (_g2 + 1);
HXDLIN( 227)								int j = (_g2 - 1);
HXLINE( 231)								::Array< ::Dynamic> _hx_tmp7 = this->get_positions();
HXDLIN( 231)								 ::lime::math::Vector2 _hx_tmp8 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0);
HXDLIN( 231)								_hx_tmp7->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,0,_hx_tmp8, ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0)));
            							}
            						}
HXLINE( 234)						::Array< ::Dynamic> _hx_tmp9 = this->get_positions();
HXDLIN( 234)						int info1 = info->codepoint;
HXDLIN( 234)						 ::lime::math::Vector2 _hx_tmp10 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,((( (Float)(position->xAdvance) ) / ( (Float)(64) )) + this->letterSpacing),(( (Float)(position->yAdvance) ) / ( (Float)(64) )));
HXDLIN( 234)						_hx_tmp9->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,info1,_hx_tmp10, ::lime::math::Vector2_obj::__alloc( HX_CTX ,(( (Float)(position->xOffset) ) / ( (Float)(64) )),(( (Float)(position->yOffset) ) / ( (Float)(64) )))));
HXLINE( 236)						lastCluster = info->cluster;
            					}
            				}
            			}
            		}
...
::Array< ::Dynamic> TextLayout_obj::get_positions(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_245_get_positions)
HXLINE( 246)		if (this->_hx___dirty) {
HXLINE( 248)			this->_hx___dirty = false;
HXLINE( 249)			this->_hx___position();
            		}
HXLINE( 252)		return this->positions;
            	}
...
int TextLayout_obj::get_direction(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_257_get_direction)
HXDLIN( 257)		return this->_hx___direction;
            	}
...
int TextLayout_obj::set_direction(int value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_261_set_direction)
HXLINE( 262)		if ((value == this->_hx___direction)) {
HXLINE( 262)			return value;
            		}
HXLINE( 264)		this->_hx___direction = value;
...
HX_DEFINE_DYNAMIC_FUNC1(TextLayout_obj,set_direction,return )
 ...
 ::lime::text::Font TextLayout_obj::set_font( ::lime::text::Font value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_271_set_font)
HXLINE( 272)		if (::hx::IsInstanceEq( value,this->font )) {
HXLINE( 272)			return value;
            		}
HXLINE( 274)		this->font = value;
...
::Array< int > TextLayout_obj::get_glyphs(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_282_get_glyphs)
HXLINE( 283)		::Array< int > glyphs = ::Array_obj< int >::__new(0);
HXLINE( 285)		{
HXLINE( 285)			int _g = 0;
HXDLIN( 285)			::Array< ::Dynamic> _g1 = this->get_positions();
HXDLIN( 285)			while((_g < _g1->length)){
HXLINE( 285)				 ::openfl::text::_internal::GlyphPosition position = _g1->__get(_g).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN( 285)				_g = (_g + 1);
HXLINE( 287)				glyphs->push(position->glyph);
            			}
            		}
HXLINE( 290)		return glyphs;
            	}
...
::String TextLayout_obj::get_language(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_295_get_language)
HXDLIN( 295)		return this->_hx___language;
            	}
...
::String TextLayout_obj::set_language(::String value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_299_set_language)
HXLINE( 300)		if ((value == this->_hx___language)) {
HXLINE( 300)			return value;
            		}
HXLINE( 302)		this->_hx___language = value;
...
::String TextLayout_obj::get_script(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_310_get_script)
HXDLIN( 310)		return this->_hx___script;
            	}
...
::String TextLayout_obj::set_script(::String value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_314_set_script)
HXLINE( 315)		if ((value == this->_hx___script)) {
HXLINE( 315)			return value;
            		}
HXLINE( 317)		this->_hx___script = value;
...
int TextLayout_obj::set_size(int value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_324_set_size)
HXLINE( 325)		if ((value == this->size)) {
HXLINE( 325)			return value;
            		}
HXLINE( 327)		this->size = value;
HXLINE( 328)		this->_hx___dirty = true;
...
::String TextLayout_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_333_set_text)
HXLINE( 334)		if ((value == this->text)) {
HXLINE( 334)			return value;
            		}
HXLINE( 336)		this->text = value;
