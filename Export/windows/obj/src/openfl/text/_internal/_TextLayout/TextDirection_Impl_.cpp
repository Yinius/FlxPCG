...
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_356_reverse,"openfl.text._internal._TextLayout.TextDirection_Impl_","reverse",0x2436bfd9,"openfl.text._internal._TextLayout.TextDirection_Impl_.reverse","openfl/text/_internal/TextLayout.hx",356,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_361_toString,"openfl.text._internal._TextLayout.TextDirection_Impl_","toString",0x426a2a15,"openfl.text._internal._TextLayout.TextDirection_Impl_.toString","openfl/text/_internal/TextLayout.hx",361,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_374_toHBDirection,"openfl.text._internal._TextLayout.TextDirection_Impl_","toHBDirection",0x47c8a441,"openfl.text._internal._TextLayout.TextDirection_Impl_.toHBDirection","openfl/text/_internal/TextLayout.hx",374,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_387_get_backward,"openfl.text._internal._TextLayout.TextDirection_Impl_","get_backward",0x1e6151d5,"openfl.text._internal._TextLayout.TextDirection_Impl_.get_backward","openfl/text/_internal/TextLayout.hx",387,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_392_get_forward,"openfl.text._internal._TextLayout.TextDirection_Impl_","get_forward",0xaa0ef013,"openfl.text._internal._TextLayout.TextDirection_Impl_.get_forward","openfl/text/_internal/TextLayout.hx",392,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_397_get_horizontal,"openfl.text._internal._TextLayout.TextDirection_Impl_","get_horizontal",0xc88b5356,"openfl.text._internal._TextLayout.TextDirection_Impl_.get_horizontal","openfl/text/_internal/TextLayout.hx",397,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_402_get_vertical,"openfl.text._internal._TextLayout.TextDirection_Impl_","get_vertical",0x615e3268,"openfl.text._internal._TextLayout.TextDirection_Impl_.get_vertical","openfl/text/_internal/TextLayout.hx",402,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_344_boot,"openfl.text._internal._TextLayout.TextDirection_Impl_","boot",0x0be1b51b,"openfl.text._internal._TextLayout.TextDirection_Impl_.boot","openfl/text/_internal/TextLayout.hx",344,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_345_boot,"openfl.text._internal._TextLayout.TextDirection_Impl_","boot",0x0be1b51b,"openfl.text._internal._TextLayout.TextDirection_Impl_.boot","openfl/text/_internal/TextLayout.hx",345,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_346_boot,"openfl.text._internal._TextLayout.TextDirection_Impl_","boot",0x0be1b51b,"openfl.text._internal._TextLayout.TextDirection_Impl_.boot","openfl/text/_internal/TextLayout.hx",346,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_347_boot,"openfl.text._internal._TextLayout.TextDirection_Impl_","boot",0x0be1b51b,"openfl.text._internal._TextLayout.TextDirection_Impl_.boot","openfl/text/_internal/TextLayout.hx",347,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_348_boot,"openfl.text._internal._TextLayout.TextDirection_Impl_","boot",0x0be1b51b,"openfl.text._internal._TextLayout.TextDirection_Impl_.boot","openfl/text/_internal/TextLayout.hx",348,0xf9c6f251)
namespace openfl{
namespace text{
namespace _internal{
...
void TextDirection_Impl__obj::reverse(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_356_reverse)
HXDLIN( 356)		this1 = (this1 ^ 1);
            	}
...
::String TextDirection_Impl__obj::toString(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_361_toString)
HXDLIN( 361)		switch((int)(this1)){
            			case (int)4: {
HXLINE( 363)				return HX_("leftToRight",1a,97,7b,b5);
            			}
            			break;
            			case (int)5: {
HXLINE( 364)				return HX_("rightToLeft",1e,40,ee,e6);
            			}
            			break;
            			case (int)6: {
HXLINE( 365)				return HX_("topToBottom",7b,ce,19,75);
            			}
            			break;
            			case (int)7: {
HXLINE( 366)				return HX_("bottomToTop",ef,ac,aa,79);
            			}
            			break;
            			default:{
HXLINE( 367)				return HX_("",00,00,00,00);
            			}
            		}
...
int TextDirection_Impl__obj::toHBDirection(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_374_toHBDirection)
HXDLIN( 374)		switch((int)(this1)){
            			case (int)4: {
HXLINE( 376)				return 4;
            			}
            			break;
...
bool TextDirection_Impl__obj::get_backward(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_387_get_backward)
HXDLIN( 387)		return ((this1 & -3) == 5);
            	}
...
bool TextDirection_Impl__obj::get_forward(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_392_get_forward)
HXDLIN( 392)		return ((this1 & -3) == 4);
            	}
...
bool TextDirection_Impl__obj::get_horizontal(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_397_get_horizontal)
HXDLIN( 397)		return ((this1 & -2) == 4);
            	}
...
bool TextDirection_Impl__obj::get_vertical(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_402_get_vertical)
HXDLIN( 402)		return ((this1 & -2) == 6);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_344_boot)
HXDLIN( 344)		INVALID = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_345_boot)
HXDLIN( 345)		LEFT_TO_RIGHT = 4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_346_boot)
HXDLIN( 346)		RIGHT_TO_LEFT = 5;
            	}
{
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_347_boot)
HXDLIN( 347)		TOP_TO_BOTTOM = 6;
            	}
{
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_348_boot)
HXDLIN( 348)		BOTTOM_TO_TOP = 7;
            	}
}
