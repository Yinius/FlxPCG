...
HX_DEFINE_STACK_FRAME(_hx_pos_eeef98c53cb575cc_2086_new,"openfl.text._internal._TextEngine.DefaultFontSet","new",0xe216cf59,"openfl.text._internal._TextEngine.DefaultFontSet.new","openfl/text/_internal/TextEngine.hx",2086,0xb85e1839)
HX_LOCAL_STACK_FRAME(_hx_pos_eeef98c53cb575cc_2094_getFont,"openfl.text._internal._TextEngine.DefaultFontSet","getFont",0x27237cfe,"openfl.text._internal._TextEngine.DefaultFontSet.getFont","openfl/text/_internal/TextEngine.hx",2094,0xb85e1839)
namespace openfl{
namespace text{
namespace _internal{
...
void DefaultFontSet_obj::__construct( ::openfl::text::Font normal, ::openfl::text::Font bold, ::openfl::text::Font italic, ::openfl::text::Font boldItalic){
            	HX_STACKFRAME(&_hx_pos_eeef98c53cb575cc_2086_new)
HXLINE(2087)		this->normal = normal;
HXLINE(2088)		this->bold = bold;
HXLINE(2089)		this->italic = italic;
HXLINE(2090)		this->boldItalic = boldItalic;
            	}
...
bool DefaultFontSet_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::text::Font DefaultFontSet_obj::getFont(bool isBold,bool isItalic){
            	HX_STACKFRAME(&_hx_pos_eeef98c53cb575cc_2094_getFont)
HXLINE(2095)		bool _hx_tmp;
HXDLIN(2095)		bool _hx_tmp1;
HXDLIN(2095)		if (isBold) {
HXLINE(2095)			_hx_tmp1 = isItalic;
            		}
            		else {
HXLINE(2095)			_hx_tmp1 = false;
            		}
HXDLIN(2095)		if (_hx_tmp1) {
HXLINE(2095)			_hx_tmp = ::hx::IsNotNull( this->boldItalic );
            		}
            		else {
HXLINE(2095)			_hx_tmp = false;
            		}
HXDLIN(2095)		if (_hx_tmp) {
HXLINE(2097)			return this->boldItalic;
            		}
HXLINE(2099)		bool _hx_tmp2;
HXDLIN(2099)		if (isItalic) {
HXLINE(2099)			_hx_tmp2 = ::hx::IsNotNull( this->italic );
            		}
            		else {
HXLINE(2099)			_hx_tmp2 = false;
            		}
HXDLIN(2099)		if (_hx_tmp2) {
HXLINE(2101)			return this->italic;
            		}
HXLINE(2103)		bool _hx_tmp3;
HXDLIN(2103)		if (isBold) {
HXLINE(2103)			_hx_tmp3 = ::hx::IsNotNull( this->bold );
            		}
            		else {
HXLINE(2103)			_hx_tmp3 = false;
            		}
HXDLIN(2103)		if (_hx_tmp3) {
HXLINE(2105)			return this->bold;
            		}
HXLINE(2107)		return this->normal;
            	}
