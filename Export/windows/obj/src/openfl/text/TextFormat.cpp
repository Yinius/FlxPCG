...
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_335_set_font,"openfl.text.TextFormat","set_font",0xe6ea6af3,"openfl.text.TextFormat.set_font","openfl/text/TextFormat.hx",335,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_345_set_size,"openfl.text.TextFormat","set_size",0xef7dade5,"openfl.text.TextFormat.set_size","openfl/text/TextFormat.hx",345,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_355_set_bold,"openfl.text.TextFormat","set_bold",0xe4458ea9,"openfl.text.TextFormat.set_bold","openfl/text/TextFormat.hx",355,0xd3329397)
HX_LOCAL_STACK_FRAME(_hx_pos_c5f39c48023aa9de_365_set_italic,"openfl.text.TextFormat","set_italic",0x5206cd14,"openfl.text.TextFormat.set_italic","openfl/text/TextFormat.hx",365,0xd3329397)
...
HXLINE( 262)		this->set_font(font);
HXLINE( 263)		this->set_size(size);
HXLINE( 264)		this->color = color;
HXLINE( 265)		this->set_bold(bold);
HXLINE( 266)		this->set_italic(italic);
...
::String TextFormat_obj::set_font(::String value){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_335_set_font)
HXLINE( 336)		if ((this->font != value)) {
HXLINE( 338)			this->font = value;
HXLINE( 339)			this->_hx___toCacheKey();
            		}
HXLINE( 341)		return this->font;
            	}


HX_DEFINE_DYNAMIC_FUNC1(TextFormat_obj,set_font,return )

 ::Dynamic TextFormat_obj::set_size( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_345_set_size)
HXLINE( 346)		if (::hx::IsNotEq( this->size,value )) {
HXLINE( 348)			this->size = value;
HXLINE( 349)			this->_hx___toCacheKey();
            		}
HXLINE( 351)		return this->size;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(TextFormat_obj,set_size,return )
 ...
 ::Dynamic TextFormat_obj::set_bold( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_355_set_bold)
HXLINE( 356)		if (::hx::IsNotEq( this->bold,value )) {
HXLINE( 358)			this->bold = value;
HXLINE( 359)			this->_hx___toCacheKey();
            		}
HXLINE( 361)		return this->bold;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(TextFormat_obj,set_bold,return )
 ...
 ::Dynamic TextFormat_obj::set_italic( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_c5f39c48023aa9de_365_set_italic)
HXLINE( 366)		if (::hx::IsNotEq( this->italic,value )) {
HXLINE( 368)			this->italic = value;
HXLINE( 369)			this->_hx___toCacheKey();
            		}
HXLINE( 371)		return this->italic;
            	}
...
::hx::Val TextFormat_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 3:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"bold") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_bold(inValue.Cast<  ::Dynamic >()) );bold=inValue.Cast<  ::Dynamic >(); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"size") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_size(inValue.Cast<  ::Dynamic >()) );size=inValue.Cast<  ::Dynamic >(); return inValue; }
		break;
	case 5:
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"italic") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_italic(inValue.Cast<  ::Dynamic >()) );italic=inValue.Cast<  ::Dynamic >(); return inValue; }
