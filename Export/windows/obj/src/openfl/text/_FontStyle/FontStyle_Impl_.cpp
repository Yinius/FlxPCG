...
HX_LOCAL_STACK_FRAME(_hx_pos_2a9064c0a4b35973_40_fromString,"openfl.text._FontStyle.FontStyle_Impl_","fromString",0x9783fd8f,"openfl.text._FontStyle.FontStyle_Impl_.fromString","openfl/text/FontStyle.hx",40,0x6b07f79f)
HX_LOCAL_STACK_FRAME(_hx_pos_2a9064c0a4b35973_52_toString,"openfl.text._FontStyle.FontStyle_Impl_","toString",0x0cd38b60,"openfl.text._FontStyle.FontStyle_Impl_.toString","openfl/text/FontStyle.hx",52,0x6b07f79f)
...
bool FontStyle_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic FontStyle_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_2a9064c0a4b35973_40_fromString)
...
::String FontStyle_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_2a9064c0a4b35973_52_toString)
HXDLIN(  52)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  54)			return HX_("bold",85,81,1b,41);
HXDLIN(  54)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  55)			return HX_("boldItalic",55,96,d1,ad);
HXDLIN(  55)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  56)			return HX_("italic",f0,2e,64,06);
HXDLIN(  56)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==3) ){
HXLINE(  57)			return HX_("regular",5c,52,88,82);
