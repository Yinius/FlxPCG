...
HX_LOCAL_STACK_FRAME(_hx_pos_d860189a36ec7114_33_fromString,"openfl.text._AntiAliasType.AntiAliasType_Impl_","fromString",0x0b2fac83,"openfl.text._AntiAliasType.AntiAliasType_Impl_.fromString","openfl/text/AntiAliasType.hx",33,0x9da7f159)
HX_LOCAL_STACK_FRAME(_hx_pos_d860189a36ec7114_43_toString,"openfl.text._AntiAliasType.AntiAliasType_Impl_","toString",0xa8e1d554,"openfl.text._AntiAliasType.AntiAliasType_Impl_.toString","openfl/text/AntiAliasType.hx",43,0x9da7f159)
...
bool AntiAliasType_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic AntiAliasType_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_d860189a36ec7114_33_fromString)
...
::String AntiAliasType_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_d860189a36ec7114_43_toString)
HXDLIN(  43)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  45)			return HX_("advanced",a2,69,7b,3b);
HXDLIN(  45)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  46)			return HX_("normal",27,72,69,30);
