...
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_62_fromString,"openfl.geom._Orientation3D.Orientation3D_Impl_","fromString",0xa47116a0,"openfl.geom._Orientation3D.Orientation3D_Impl_.fromString","openfl/geom/Orientation3D.hx",62,0xf4ac08f1)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_73_toString,"openfl.geom._Orientation3D.Orientation3D_Impl_","toString",0xf11d8e31,"openfl.geom._Orientation3D.Orientation3D_Impl_.toString","openfl/geom/Orientation3D.hx",73,0xf4ac08f1)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_30_boot,"openfl.geom._Orientation3D.Orientation3D_Impl_","boot",0xe951db37,"openfl.geom._Orientation3D.Orientation3D_Impl_.boot","openfl/geom/Orientation3D.hx",30,0xf4ac08f1)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_46_boot,"openfl.geom._Orientation3D.Orientation3D_Impl_","boot",0xe951db37,"openfl.geom._Orientation3D.Orientation3D_Impl_.boot","openfl/geom/Orientation3D.hx",46,0xf4ac08f1)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_58_boot,"openfl.geom._Orientation3D.Orientation3D_Impl_","boot",0xe951db37,"openfl.geom._Orientation3D.Orientation3D_Impl_.boot","openfl/geom/Orientation3D.hx",58,0xf4ac08f1)
namespace openfl{
namespace geom{
...
bool Orientation3D_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Orientation3D_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_62_fromString)
HXDLIN(  62)		::String _hx_switch_0 = value;
...
::String Orientation3D_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_73_toString)
HXDLIN(  73)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  75)			return HX_("axisAngle",72,2f,86,7c);
HXDLIN(  75)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  76)			return HX_("eulerAngles",89,d7,c4,64);
HXDLIN(  76)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  77)			return HX_("quaternion",1e,0d,ca,1b);
...
{
{
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_30_boot)
HXDLIN(  30)		AXIS_ANGLE = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_46_boot)
HXDLIN(  46)		EULER_ANGLES = 1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_58_boot)
HXDLIN(  58)		QUATERNION = 2;
            	}
}
