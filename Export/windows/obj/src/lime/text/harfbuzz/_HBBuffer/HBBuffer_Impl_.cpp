...
HXLINE(  94)				 ::haxe::io::Bytes _this = bytes;
HXDLIN(  94)				info->codepoint = (((( (int)(_this->b->__get(position)) ) | (( (int)(_this->b->__get((position + 1))) ) << 8)) | (( (int)(_this->b->__get((position + 2))) ) << 16)) | (( (int)(_this->b->__get((position + 3))) ) << 24));
HXLINE(  95)				position = (position + 4);
HXLINE(  96)				 ::haxe::io::Bytes _this1 = bytes;
HXDLIN(  96)				info->mask = (((( (int)(_this1->b->__get(position)) ) | (( (int)(_this1->b->__get((position + 1))) ) << 8)) | (( (int)(_this1->b->__get((position + 2))) ) << 16)) | (( (int)(_this1->b->__get((position + 3))) ) << 24));
HXLINE(  97)				position = (position + 4);
HXLINE(  98)				 ::haxe::io::Bytes _this2 = bytes;
HXDLIN(  98)				info->cluster = (((( (int)(_this2->b->__get(position)) ) | (( (int)(_this2->b->__get((position + 1))) ) << 8)) | (( (int)(_this2->b->__get((position + 2))) ) << 16)) | (( (int)(_this2->b->__get((position + 3))) ) << 24));
...
HXLINE( 130)				 ::haxe::io::Bytes _this = bytes;
HXDLIN( 130)				glyphPosition->xAdvance = (((( (int)(_this->b->__get(position)) ) | (( (int)(_this->b->__get((position + 1))) ) << 8)) | (( (int)(_this->b->__get((position + 2))) ) << 16)) | (( (int)(_this->b->__get((position + 3))) ) << 24));
HXLINE( 131)				position = (position + 4);
HXLINE( 132)				 ::haxe::io::Bytes _this1 = bytes;
HXDLIN( 132)				glyphPosition->yAdvance = (((( (int)(_this1->b->__get(position)) ) | (( (int)(_this1->b->__get((position + 1))) ) << 8)) | (( (int)(_this1->b->__get((position + 2))) ) << 16)) | (( (int)(_this1->b->__get((position + 3))) ) << 24));
HXLINE( 133)				position = (position + 4);
HXLINE( 134)				 ::haxe::io::Bytes _this2 = bytes;
HXDLIN( 134)				glyphPosition->xOffset = (((( (int)(_this2->b->__get(position)) ) | (( (int)(_this2->b->__get((position + 1))) ) << 8)) | (( (int)(_this2->b->__get((position + 2))) ) << 16)) | (( (int)(_this2->b->__get((position + 3))) ) << 24));
HXLINE( 135)				position = (position + 4);
HXLINE( 136)				 ::haxe::io::Bytes _this3 = bytes;
HXDLIN( 136)				glyphPosition->yOffset = (((( (int)(_this3->b->__get(position)) ) | (( (int)(_this3->b->__get((position + 1))) ) << 8)) | (( (int)(_this3->b->__get((position + 2))) ) << 16)) | (( (int)(_this3->b->__get((position + 3))) ) << 24));
