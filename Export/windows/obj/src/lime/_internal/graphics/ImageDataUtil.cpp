...
HXLINE(1435)		{
HXLINE(1435)			 ::lime::utils::ArrayBufferView _this = imgB;
HXDLIN(1435)			::cpp::VirtualArray array = null();
...
HXLINE(1435)				_this->buffer->blit((offset * _this->bytesPerElement),imgA->buffer,imgA->byteOffset,imgA->byteLength);
            			}
            			else {
...
HXLINE(1435)					_this->copyFromArray(array,offset);
            				}
            				else {
