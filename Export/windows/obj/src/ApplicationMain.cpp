...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("FlxPCG",e2,71,d0,7b),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Universidad de Colima",fa,49,3d,db));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("FlxPCG",e2,71,d0,7b));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("FlxPCG",e2,71,d0,7b));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("ucol.flxpcg",05,c5,97,9a));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("FlxPCG",e2,71,d0,7b))
