...
class HXCPP_CLASS_ATTRIBUTES FlxPoint_Impl__obj : public ::hx::Object
{
	...
	public:
		...
		static Float dotProductXY( ::flixel::math::FlxBasePoint this1,Float x,Float y);
		static ::Dynamic dotProductXY_dyn();
		...
		static  ::flixel::math::FlxBasePoint negateNew( ::flixel::math::FlxBasePoint this1, ::flixel::math::FlxBasePoint result);
		...
		static Float perpProductXY( ::flixel::math::FlxBasePoint this1,Float x,Float y);
		static ::Dynamic perpProductXY_dyn();
