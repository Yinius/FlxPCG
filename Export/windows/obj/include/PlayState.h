...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::flixel::FlxState_obj
{
	...
	public:
		...
		int currentDifficulty;
		 ::pcg::MapGenerator generator;
		 ::flixel::group::FlxTypedGroup mapGroup;
		 ::flixel::text::FlxText statsText;
		...
		::Dynamic setDifficulty_dyn();

		void handleCamera(Float elapsed);
		::Dynamic handleCamera_dyn();

		 ::flixel::text::FlxText makeHudText(Float x,Float y,int width);
		::Dynamic makeHudText_dyn();
