...
class HXCPP_CLASS_ATTRIBUTES DisplayObjectRenderer_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		bool _hx___affineChanged( ::openfl::geom::Matrix a, ::openfl::geom::Matrix b,::hx::Null< Float >  eps);
		::Dynamic _hx___affineChanged_dyn();

		bool _hx___isShaderFilter( ::Dynamic f);
		::Dynamic _hx___isShaderFilter_dyn();
